...
status_t sdp_decomp_training_kernel_t::compile_impl(
    ...
    VCHECK_SDP_DECOMP_TRAIN(g_engine->kind() == engine_kind::cpu,
...
status_t sdp_decomp_training_kernel_t::execute_impl(const stream_t *g_stream,
