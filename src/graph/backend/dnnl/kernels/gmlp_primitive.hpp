...
#ifndef GRAPH_BACKEND_DNNL_KERNELS_GMLP_PRIMITIVE_HPP
#define GRAPH_BACKEND_DNNL_KERNELS_GMLP_PRIMITIVE_HPP
...
struct gmlp_primitive_kernel_t : public kernel_base_t {
private:
    ...
    gmlp_primitive_config_t cfg_;

public:
    gmlp_primitive_kernel_t() {
        thread_local_cache_t<execution_args_set_t> res_cache;
        res_cache.retain();
    }

    ~gmlp_primitive_kernel_t() override {
        thread_local_cache_t<execution_args_set_t> res_cache;
    ...
    status_t get_prim_exec_args(exec_args_t &args, memory (&mem_storage)[5],
    ...
    DEF_KERNEL_METHOD_STR(gmlp_primitive_kernel_t)
    DNNL_DISALLOW_COPY_AND_ASSIGN(gmlp_primitive_kernel_t)
};
