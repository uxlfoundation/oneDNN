...
int main() {
    ...
    std::vector<int64_t> dot1_in2_shape {16, 256, 1};
    std::vector<int64_t> dot1_out_shape {
            16, 128, 1}; // also multiply 2nd operand shape
    ...
    std::vector<int64_t> reshape1_out_shape {1, 16, 1, 1, 128};
    ...
    std::vector<int64_t> add_in2_shape {1, 16, 1, 1, 128};

    logical_tensor lt_add_in2 {lt_id++, logical_tensor::data_type::f32,
            add_in2_shape, logical_tensor::layout_type::strided};
    ...
    add_op.add_output(lt_add_out); // output shape is {1,16,1,1,128}
    ...
    softmax_op.add_output(lt_softmax_out); //output shape is {1,16,1,1,128}

    std::vector<int64_t> reshape2_out_shape {
            16, 128, 1}; // input shape {1,16,1,1,128}
