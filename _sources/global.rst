...
.. ref-code-block:: cpp
	...
	typedef :ref:`logical_tensor::property_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1a037ba7c242d8127d2f42c0c2aef29d82>` :target:`property_type<doxid-gqa_8cpp_1a4843da079c19b156c5d61734c9a05bff>`;
	...
	typedef :ref:`logical_tensor::layout_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1ad3fcaff44671577e56adb03b770f4867>` :target:`layout_type<doxid-gqa__training_8cpp_1ac1b25e3cc344221674ec31350ae4ad66>`;
	typedef :ref:`logical_tensor::dim<doxid-classdnnl_1_1graph_1_1logical__tensor_1a759c7b96472681049e17716334a2b334>` :target:`dim<doxid-gqa__training_8cpp_1ad83b61f43e3156ef3292c573495099d2>`;
	typedef :ref:`logical_tensor::dims<doxid-classdnnl_1_1graph_1_1logical__tensor_1a31af724d1ea783a09b6900d69b43ddc7>` :target:`dims<doxid-gqa__training_8cpp_1a47c77b261e3284fd1ade12bb3a418347>`;
	...
	typedef :ref:`logical_tensor::layout_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1ad3fcaff44671577e56adb03b770f4867>` :target:`layout_type<doxid-sdpa__quantized_8cpp_1ac1b25e3cc344221674ec31350ae4ad66>`;
	typedef :ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` :target:`data_type<doxid-sdpa__quantized_8cpp_1a35af718e2cb46e555772662cef6435c2>`;
	typedef :ref:`logical_tensor::dim<doxid-classdnnl_1_1graph_1_1logical__tensor_1a759c7b96472681049e17716334a2b334>` :target:`dim<doxid-sdpa__quantized_8cpp_1ad83b61f43e3156ef3292c573495099d2>`;
	typedef :ref:`logical_tensor::dims<doxid-classdnnl_1_1graph_1_1logical__tensor_1a31af724d1ea783a09b6900d69b43ddc7>` :target:`dims<doxid-sdpa__quantized_8cpp_1a47c77b261e3284fd1ade12bb3a418347>`;
	...
	enum :ref:`dnnl_quantization_mode_t<doxid-group__dnnl__api__attributes_1ga5342e1d6b2a09ea01660b3a3c2400826>`;
	...
	static const int :target:`min_runs<doxid-gqa__training_8cpp_1ae659a2a0d78779a2018a1939ff3c9374>` = 4;
	...
	static const int :target:`min_runs<doxid-sdpa__quantized_8cpp_1ae659a2a0d78779a2018a1939ff3c9374>` = 4;
	...
	int :target:`number_of_runs<doxid-matmul__with__weight__only__quantization_8cpp_1afeb16b6f12b370b3c0e69e1e40c00e57>` = 1;
	const :ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` :target:`mx_block_size<doxid-mxfp__matmul_8cpp_1ad28bdc3c199632a08b943614dcc01223>` = 32;
	int :target:`number_of_runs<doxid-mxfp__matmul_8cpp_1afeb16b6f12b370b3c0e69e1e40c00e57>` = 1;
	...
	void :target:`compute_attention<doxid-cpu__rnn__inference__f32_8cpp_1a4681e56d5be37aa1792d19699adab8d3>`(
		...
		const :ref:`memory<doxid-structdnnl_1_1memory>`& src_f32_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& wei_f32_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& dst_f32_mem,
		const :ref:`matmul<doxid-structdnnl_1_1matmul>`& matmul_f32_prim,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& src_gemv_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& wei_gemv_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& dst_gemv_mem,
		const :ref:`matmul<doxid-structdnnl_1_1matmul>`& matmul_gemv_prim,
		:ref:`stream<doxid-structdnnl_1_1stream>`& strm
		);
	...
	void :target:`compute_attention<doxid-cpu__rnn__inference__int8_8cpp_1a6972791d7c0f144228436d57f6b54c96>`(
		float* context_vectors,
		dim_t src_seq_length_max,
		dim_t batch,
		dim_t feature_size,
		...
		uint8_t* annotations,
		float* weighted_annotations,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& src_u8_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& wei_s8_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& dst_s32_mem,
		const :ref:`matmul<doxid-structdnnl_1_1matmul>`& matmul_int8_prim,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& src_gemv_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& wei_gemv_mem,
		const :ref:`memory<doxid-structdnnl_1_1memory>`& dst_gemv_mem,
		const :ref:`matmul<doxid-structdnnl_1_1matmul>`& matmul_gemv_prim,
	...
	void :target:`read_from_dnnl_memory<doxid-example__utils_8hpp_1a40cd76621e1642075fa2d4002599ff9e>`(
		void* handle,
		:ref:`dnnl::memory<doxid-structdnnl_1_1memory>`& mem,
		int buffer_index = 0
		);

	void :target:`write_to_dnnl_memory<doxid-example__utils_8hpp_1a7be09621e54eec1fb7ccfeb69e817f0b>`(void* handle, :ref:`dnnl::memory<doxid-structdnnl_1_1memory>`& mem, int buffer_index = 0);
	...
	:ref:`fpmath_mode<doxid-group__dnnl__api__cpp__fpmath__mode_1ga0ad94cbef13dce222933422bfdcfa725>` :target:`get_fpmath_mode<doxid-gated__mlp__int4_8cpp_1a5c7df47fe9105313481512024a6e3a37>`(:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt);
	...
	void :target:`fill_random<doxid-gqa__training_8cpp_1a945d67df1b51ac53a2b53c1b02af800e>`(std::vector<float>& out);
	void :target:`fill_mask<doxid-gqa__training_8cpp_1a1d795112054e2ca82bee981c1289668c>`(std::vector<float>& mask, size_t seq_len);
	const char* :target:`get_type_string<doxid-gqa__training_8cpp_1ab20be8dd2df4221863e907a25961b992>`(:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt);
	void :target:`print_test_case<doxid-gqa__training_8cpp_1ab67d2e82ce2e5f739565b5286630df4e>`(:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt, const gqa_dims_t& p);

	bool :target:`bench_gqa_forward<doxid-gqa__training_8cpp_1a673ae5636c64136f1757fe75d674c616>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt,
		:ref:`dnnl::stream<doxid-structdnnl_1_1stream>`& strm,
		:ref:`dnnl::engine<doxid-structdnnl_1_1engine>`& eng,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_query,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_key,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_scale,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_mask,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_value,
		:ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_output,
		:ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_stats,
		double time_limit = 0.
		);

	bool :target:`bench_gqa_backward<doxid-gqa__training_8cpp_1a1321ff360d2f58ddcef8852e545c4f30>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt,
		:ref:`dnnl::stream<doxid-structdnnl_1_1stream>`& strm,
		:ref:`dnnl::engine<doxid-structdnnl_1_1engine>`& eng,
		...
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_mask,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_value,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_output,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_stats,
		const :ref:`tensor<doxid-classdnnl_1_1graph_1_1tensor>`& ts_doutput,
		double time_limit = 0.
		);

	void :target:`bench_gqa<doxid-gqa__training_8cpp_1aa736d0fb4ac4292c4ecec1fda033ac15>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt,
		const gqa_dims_t& p,
		double time_limit = 0.
	...
	void :target:`bad_args<doxid-gqa__training_8cpp_1a847ab4e9bab0692595af2434ac34f2c1>`();

	void :target:`bench<doxid-gqa__training_8cpp_1a4e0caaef03229eaf1934269ff1c94ee5>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` dt,
		const gqa_dims_t& p,
		double time_limit = 0.
	...
	void :target:`gqa_perf<doxid-gqa__training_8cpp_1a166367067c34da3772f6cab5e04212f9>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind, int argc, char** argv);
	int :target:`main<doxid-gqa__training_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	...
	void :target:`fill_random<doxid-sdpa__quantized_8cpp_1a945d67df1b51ac53a2b53c1b02af800e>`(std::vector<float>& out);
	void :target:`fill_mask<doxid-sdpa__quantized_8cpp_1a1d795112054e2ca82bee981c1289668c>`(std::vector<float>& mask, size_t seq_len);
	const char* :target:`get_type_string<doxid-sdpa__quantized_8cpp_1ab20be8dd2df4221863e907a25961b992>`(:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt);
	void :target:`print_test_case<doxid-sdpa__quantized_8cpp_1a33840fde2b7dfb82790c76625c1260af>`(:ref:`logical_tensor::data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt, const sdpa_dims_t& p);

	void :target:`bench_quantized_sdpa<doxid-sdpa__quantized_8cpp_1a62ffe94149c52083ab6176c79c532aaf>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		const :ref:`data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt,
		const sdpa_dims_t& p,
		double time_limit = 0.
		);

	void :target:`bad_args<doxid-sdpa__quantized_8cpp_1a847ab4e9bab0692595af2434ac34f2c1>`();

	void :target:`bench<doxid-sdpa__quantized_8cpp_1a5a016523195d4f73a423f0a8a1fc1690>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind,
		const :ref:`data_type<doxid-classdnnl_1_1graph_1_1logical__tensor_1acddb1dc65b7b4feede7710a719f32227>` dt,
		const sdpa_dims_t& p,
		double time_limit = 0.
	...
	void :target:`sdpa_perf<doxid-sdpa__quantized_8cpp_1aabdbec83e0aeef632285da8ab74533a4>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` ekind, int argc, char** argv);
	int :target:`main<doxid-sdpa__quantized_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	...
	float :ref:`decode_f8_e4m3<doxid-matmul__f8__quantization_8cpp_1af10e2a1b070ff28ad721dadc002c32fb>`(uint8_t f8_val);
	float :ref:`decode_f8_e5m2<doxid-matmul__f8__quantization_8cpp_1af99fc92c80e5c4f26d93008b153269b2>`(uint8_t f8_val);
	std::string :ref:`get_f8_type_name<doxid-matmul__f8__quantization_8cpp_1a0541b3ebe4674baa408a55bce2ae2d44>`(:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` dt);
	float :ref:`return_max_value<doxid-matmul__f8__quantization_8cpp_1ab3ff494ca02611ae4de07668e6df34e0>`(:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` dt);

	float :ref:`compute_naive_quantization<doxid-matmul__f8__quantization_8cpp_1af80d177ec75286e76683f288a9882472>`(
		const float* data,
		size_t size,
		:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` dst_type,
		const std::string& label
		);

	void :ref:`perform_matmul_with_f8_quantization<doxid-matmul__f8__quantization_8cpp_1a3c24699995bb959b49ed2cb30b1abc90>`(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind,
		:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` f8_type = memory::data_type::f8_e5m2
		);

	void :target:`run_f8_tutorials<doxid-matmul__f8__quantization_8cpp_1a627cde86217ff48e70c3dba2ec88cadc>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind);
	int :target:`main<doxid-matmul__f8__quantization_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	void :target:`grouped_matmul_example<doxid-matmul__grouped_8cpp_1a5b516ba6ced9e687a17ec3e468938560>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind);
	int :target:`main<doxid-matmul__grouped_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	...
	bool :target:`check_result<doxid-matmul__with__host__scalar__scale_8cpp_1ac912f0469035497261cd6585b3a9c227>`(
	...
	void :target:`simple_matmul_with_host_scalar<doxid-matmul__with__host__scalar__scale_8cpp_1a1ce9a9a57970365c3835b1971a0ec204>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind);
	int :target:`main<doxid-matmul__with__host__scalar__scale_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	...
	:ref:`matmul::primitive_desc<doxid-structdnnl_1_1matmul_1_1primitive__desc>` :target:`matmul_pd_create<doxid-matmul__with__weight__only__quantization_8cpp_1a6e0f153b5e2095dd5c65790bc315db50>`(
		int64_t M,
		int64_t N,
		int64_t K,
		int64_t G,
	...
	void :target:`prepare_input<doxid-matmul__with__weight__only__quantization_8cpp_1a1fb85dd30cf34ad03aab62876bcf8861>`(:ref:`memory<doxid-structdnnl_1_1memory>`& A_f32_mem, :ref:`memory<doxid-structdnnl_1_1memory>`& sc_B_mem, :ref:`memory<doxid-structdnnl_1_1memory>`& zp_B_mem);

	void :target:`infer<doxid-matmul__with__weight__only__quantization_8cpp_1a78b5cb67ed4bdf0ae88db106cb725439>`(
		const :ref:`matmul<doxid-structdnnl_1_1matmul>`& matmul_p,
		int64_t M,
		int64_t N,
		int64_t K,
	...
	void :target:`matmul_with_weight_only_quantization<doxid-matmul__with__weight__only__quantization_8cpp_1a2d252b63cc5b03f98ee12ba633277ebb>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind);
	int :target:`main<doxid-matmul__with__weight__only__quantization_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);

	:ref:`matmul::primitive_desc<doxid-structdnnl_1_1matmul_1_1primitive__desc>` :target:`matmul_pd_create<doxid-mxfp__matmul_8cpp_1aa5e86c64ac0c68a01c91188fdfd23f4c>`(
		int64_t M,
		int64_t N,
		int64_t K,
		const :ref:`engine<doxid-structdnnl_1_1engine>`& eng
	...
	void :target:`quantize_input<doxid-mxfp__matmul_8cpp_1a95a5ed3ed29da63380d024214c28a9f8>`(:ref:`memory<doxid-structdnnl_1_1memory>`& in_e4m3, :ref:`memory<doxid-structdnnl_1_1memory>`& in_scales_e8m0);
	void :target:`mxfp_matmul<doxid-mxfp__matmul_8cpp_1a9a857bf9ad9794af05d6296161239dca>`(:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind);
	int :target:`main<doxid-mxfp__matmul_8cpp_1a3c04138a5bfe5d72780bb7e82a18e627>`(int argc, char** argv);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_get_dropout<doxid-group__dnnl__api__attributes_1gaa99e375cd5745218290260ff7b9e56e2>`(
		:ref:`const_dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga871d7ee732a90fec43f1c878581bb59a>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>`* mask_desc
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_dropout<doxid-group__dnnl__api__attributes_1ga29956085de89106951a10f290e4aab87>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>` mask_desc
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_get_dropout_v2<doxid-group__dnnl__api__attributes_1gab454f97e8357612891a66cf99a9a51a1>`(
		:ref:`const_dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga871d7ee732a90fec43f1c878581bb59a>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>`* mask_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>`* seed_dt,
		int* use_offset,
		int* use_host_scalars
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_dropout_v2<doxid-group__dnnl__api__attributes_1ga7cb40c98418d2d1098759a29ba018e73>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>` mask_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` seed_dt,
		int use_offset,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_scales<doxid-group__dnnl__api__attributes_1ga106d72578021ab7ac79c227ee3a886e7>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int group_ndims,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_scales_v2<doxid-group__dnnl__api__attributes_1gafc415a17846b560f017b48a0991ddd65>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_scales_v3<doxid-group__dnnl__api__attributes_1ga535630984f8fdbeda4b80a745e093091>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
		...
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` data_type,
		int is_on_host,
		:ref:`dnnl_quantization_mode_t<doxid-group__dnnl__api__attributes_1ga5342e1d6b2a09ea01660b3a3c2400826>` qmode
		);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_zero_points<doxid-group__dnnl__api__attributes_1ga035d40992980f8726b2d18b3e51fb296>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int group_ndims,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_precomputed_reductions<doxid-group__dnnl__api__attributes_1ga8a3a3116cdd4e0708416cbfd338e0637>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int group_ndims,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_primitive_attr_set_zero_points_v2<doxid-group__dnnl__api__attributes_1ga36b22235abbb4e24b4284fa7ade0167f>`(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_memory_desc_create_with_grouped_encoding<doxid-group__dnnl__api__memory_1ga131454ec794a5eef89686ab0344a7111>`(
		:ref:`dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1gad281fd59c474d46a60f9b3a165e9374f>`* memory_desc,
		int ndims,
		const :ref:`dnnl_dims_t<doxid-group__dnnl__api__data__types_1ga8331e1160e52a5d4babe96736464095a>` dims,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` data_type,
		int variable_dim_idx,
		:ref:`dnnl_dim_t<doxid-group__dnnl__api__data__types_1ga872631b12a112bf43fba985cba24dd20>` group_count,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` offsets_dt
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_memory_desc_create_host_scalar<doxid-group__dnnl__api__memory_1gae52f3003429b2a60bd15b710977fe361>`(
		:ref:`dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1gad281fd59c474d46a60f9b3a165e9374f>`* memory_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` data_type
		);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_memory_create_host_scalar<doxid-group__dnnl__api__memory_1gabe53ba0e17bcb92509c3bbbd250e520b>`(
		:ref:`dnnl_memory_t<doxid-group__dnnl__api__memory_1ga2b79954bd7bb293e766a89189e8440fd>`* memory,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>` memory_desc,
		void* scalar_ptr
		);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_memory_get_host_scalar_value<doxid-group__dnnl__api__memory_1ga1c9c615901b76e4493d7c9c8f299e7ed>`(
		:ref:`const_dnnl_memory_t<doxid-group__dnnl__api__memory_1ga0f89ee8e9b55b302b3f5277d11302f7e>` memory,
		void* value
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_memory_set_host_scalar_value<doxid-group__dnnl__api__memory_1ga6be28e263bcee8d85684ed218902f995>`(
		:ref:`dnnl_memory_t<doxid-group__dnnl__api__memory_1ga2b79954bd7bb293e766a89189e8440fd>` memory,
		const void* value
		);
	...
	const char DNNL_API* :target:`dnnl_quantization_mode2str<doxid-oneapi_2dnnl_2dnnl__debug_8h_1a088bdf175011260afaf7b9f589aee7a6>`(:ref:`dnnl_quantization_mode_t<doxid-group__dnnl__api__attributes_1ga5342e1d6b2a09ea01660b3a3c2400826>` v);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_verbose_profiling_enabled<doxid-group__dnnl__api__service_1ga50608f3f3888ebbb3d007a50a63e0e04>`(int* enabled);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_graph_compiled_partition_execute_v2<doxid-group__dnnl__graph__api__compiled__partition_1ga206bdc77b181243b01ffecf3e654e07c>`(
		:ref:`const_dnnl_graph_compiled_partition_t<doxid-group__dnnl__graph__api__compiled__partition_1gac1af164b5c86e9a3ff3c13583da98f06>` compiled_partition,
		:ref:`dnnl_stream_t<doxid-group__dnnl__api__stream_1ga735eb19cfd205c108c468b5657de4eca>` stream,
		size_t num_inputs,
		:ref:`const_dnnl_graph_tensor_t<doxid-group__dnnl__graph__api__tensor_1ga501fef96950f38448cb326c776e8d068>`* inputs,
		size_t num_outputs,
		:ref:`const_dnnl_graph_tensor_t<doxid-group__dnnl__graph__api__tensor_1ga501fef96950f38448cb326c776e8d068>`* outputs,
		:ref:`const_dnnl_graph_tensor_t<doxid-group__dnnl__graph__api__tensor_1ga501fef96950f38448cb326c776e8d068>` scratchpad
		);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_graph_compiled_partition_get_scratchpad_logical_tensor<doxid-group__dnnl__graph__api__compiled__partition_1ga9cb97527086e7857cf99b05d0fc8c25a>`(
		:ref:`const_dnnl_graph_compiled_partition_t<doxid-group__dnnl__graph__api__compiled__partition_1gac1af164b5c86e9a3ff3c13583da98f06>` compiled_partition,
		:ref:`dnnl_graph_logical_tensor_t<doxid-structdnnl__graph__logical__tensor__t>`* lt
		);
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_graph_ocl_interop_compiled_partition_execute_v2<doxid-group__dnnl__graph__api__ocl__interop_1gaa3d283111409da41df68d0a474c96a40>`(
		:ref:`const_dnnl_graph_compiled_partition_t<doxid-group__dnnl__graph__api__compiled__partition_1gac1af164b5c86e9a3ff3c13583da98f06>` compiled_partition,
		:ref:`dnnl_stream_t<doxid-group__dnnl__api__stream_1ga735eb19cfd205c108c468b5657de4eca>` stream,
		size_t num_inputs,
		:ref:`const_dnnl_graph_tensor_t<doxid-group__dnnl__graph__api__tensor_1ga501fef96950f38448cb326c776e8d068>`* inputs,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_graph_sycl_interop_compiled_partition_execute_v2<doxid-group__dnnl__graph__api__sycl__interop_1ga56f7253719bc266e2f1aa85370cca865>`(
		:ref:`const_dnnl_graph_compiled_partition_t<doxid-group__dnnl__graph__api__compiled__partition_1gac1af164b5c86e9a3ff3c13583da98f06>` compiled_partition,
		:ref:`dnnl_stream_t<doxid-group__dnnl__api__stream_1ga735eb19cfd205c108c468b5657de4eca>` stream,
		size_t num_inputs,
		:ref:`const_dnnl_graph_tensor_t<doxid-group__dnnl__graph__api__tensor_1ga501fef96950f38448cb326c776e8d068>`* inputs,
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_ze_interop_engine_get_cache_blob_id<doxid-group__dnnl__api__ze__interop_1gab47027d3d859c24a07060b0ffc19f2da>`(
	...
	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_ze_interop_engine_get_cache_blob<doxid-group__dnnl__api__ze__interop_1gae48eaec22ed32acb6ff38e0bc0d7b8e5>`(
		:ref:`dnnl_engine_t<doxid-group__dnnl__api__engine_1ga1ce7843660e8203ed6e1af9bfd23e14f>` engine,
		size_t* size,
		uint8_t* cache_blob
		);

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API :ref:`dnnl_ze_interop_engine_create_from_cache_blob<doxid-group__dnnl__api__ze__interop_1gaf83e20191a60b265e4e6f1f841266b04>`(
		:ref:`dnnl_engine_t<doxid-group__dnnl__api__engine_1ga1ce7843660e8203ed6e1af9bfd23e14f>`* engine,
		ze_driver_handle_t driver,
		ze_device_handle_t device,
	...
	#define :target:`TYPE_CASE<doxid-gqa__training_8cpp_1a938ca528442b632c4ac86e2fb08badb9>`(T)
	...
	#define :target:`TYPE_CASE<doxid-sdpa__quantized_8cpp_1a938ca528442b632c4ac86e2fb08badb9>`(T)
...
.. index:: pair: function; decode_f8_e4m3
.. _doxid-matmul__f8__quantization_8cpp_1af10e2a1b070ff28ad721dadc002c32fb:
...
.. index:: pair: function; decode_f8_e5m2
.. _doxid-matmul__f8__quantization_8cpp_1af99fc92c80e5c4f26d93008b153269b2:
...
.. index:: pair: function; get_f8_type_name
.. _doxid-matmul__f8__quantization_8cpp_1a0541b3ebe4674baa408a55bce2ae2d44:
...
.. index:: pair: function; return_max_value
.. _doxid-matmul__f8__quantization_8cpp_1ab3ff494ca02611ae4de07668e6df34e0:
...
.. note:: 
   ...
   Values are based on the OCP f8 specification and hardcoded here for simplicity.
...
.. index:: pair: function; compute_naive_quantization
.. _doxid-matmul__f8__quantization_8cpp_1af80d177ec75286e76683f288a9882472:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	float compute_naive_quantization(
		const float* data,
		size_t size,
		:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` dst_type,
		const std::string& label
...
.. note:: 
   ...
   This naive implementation computes a single scaling factor for the entire matrix based on the maximum absolute value. It will not produce proper results for all input distributions.
...
.. list-table::
	...
	*
		...
		- Destination data type (f8_e5m2 or f8_e4m3)

	*
		- label

		- Label for the matrix (e.g., "Source", "Weights")
...
.. index:: pair: function; perform_matmul_with_f8_quantization
.. _doxid-matmul__f8__quantization_8cpp_1a3c24699995bb959b49ed2cb30b1abc90:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void perform_matmul_with_f8_quantization(
		:ref:`engine::kind<doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind,
		:ref:`memory::data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` f8_type = memory::data_type::f8_e5m2
		)

Demonstrates matrix multiplication using f8 data types with scaling.
...
.. list-table::
	...
	*
		...
		- Execution engine kind (CPU or GPU)

	*
		- f8_type

		- f8 data type (f8_e5m2 or f8_e4m3)
