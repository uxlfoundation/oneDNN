...
void jit_brgemm_matmul_copy_a_transposed_impl_t<Vmm>::transpose_bf16(
    ...
    jit_generator_t::transpose2(reg_src, reg_dst, src_stride, dst_stride, A_rows,
            A_columns, data_type::bf16, ymm_tmp, ymm_tail_mask,
            xmm_upper_tail_mask);
    ...
    jit_generator_t::transpose2(reg_src, reg_dst, src_stride, dst_stride, B_rows,
            B_columns, data_type::bf16, ymm_tmp, ymm_tail_mask,
            xmm_upper_tail_mask);
    ...
    jit_generator_t::transpose2(reg_src, reg_dst, src_stride, dst_stride, C_rows,
            C_columns, data_type::bf16, ymm_tmp, ymm_tail_mask,
            xmm_upper_tail_mask);
    ...
    jit_generator_t::transpose2(reg_src, reg_dst, src_stride, dst_stride, D_rows,
            D_columns, data_type::bf16, ymm_tmp, ymm_tail_mask,
            xmm_upper_tail_mask);
