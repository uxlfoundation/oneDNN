...
/// Initializes a BRGEMV descriptor for batched matrix-vector multiplication.
///
/// @param brg     Output BRGEMM descriptor.
/// @param dt_a    Data type of matrix A. Supported types: f32, u8, bf16, f16.
/// @param dt_x    Data type of input vector x. Supported types: f32, s8, bf16,
///                f16.
/// @note
