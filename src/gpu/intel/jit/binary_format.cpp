...
public:
    ...
    static compute::kernel_t make_kernel(
            compute::engine_t *engine, bool *skip_check) {
...
status_t gpu_supports_binary_format(bool *ok, impl::engine_t *engine) {
    *ok = false;
    ...
    auto gpu_engine = utils::downcast<compute::engine_t *>(engine);
    ...
    auto stream = utils::downcast<compute::stream_t *>(stream_generic);
    ...
    *reinterpret_cast<uint32_t *>(result_host) = 0;
    ...
    auto compute_stream = utils::downcast<compute::stream_t *>(stream);
