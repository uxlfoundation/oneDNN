...
status_t lookup_zero_pool(compute::engine_t *engine, compute::stream_t *stream,
...
zero_pool_t::zero_pool_t(compute::engine_t *engine, size_t chunk_size,
...
status_t zero_pool_t::claim_unpooled(compute::stream_t *stream, size_t len,
...
status_t zero_pool_t::claim(compute::stream_t *stream, size_t len,
