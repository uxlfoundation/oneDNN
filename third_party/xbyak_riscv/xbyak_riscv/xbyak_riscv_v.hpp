...
void vfwmaccbf16_vf(const VReg& vd, const FReg& rs1, const VReg& vs2, VM vm=VM::unmasked) { opFVF(0xee005057, vm, vs2, rs1, vd); }
void vfwmaccbf16_vv(const VReg& vd, const VReg& vs1, const VReg& vs2, VM vm=VM::unmasked) { opFVV(0xee001057, vm, vs2, vs1, vd); }
