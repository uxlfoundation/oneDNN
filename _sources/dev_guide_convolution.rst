...
:math:`\diffweights`                                        DNNL_ARG_DIFF_WEIGHTS                                                                                                                                               Output   
:math:`\diffbias`                                           DNNL_ARG_DIFF_BIAS                                                                                                                                                  Output   
:math:`\diffdst`                                            DNNL_ARG_DIFF_DST                                                                                                                                                   Input    
:math:`depthwise`                                           DNNL_ARG_ATTR_POST_OP_DW                                                                                                                                            Input    
...
============  ==========  ============================================================================================  ===========================================================================================  =============================================================================================================  
forward       attribute   :ref:`Scale <doxid-structdnnl_1_1primitive__attr_1ac3dc9efa6702a5eba6f289f1b3907590>`         Scales the result of convolution by given scale factor(s)                                    int8 and fp8 convolutions only                                                                                 
...
Scales and zero-points require additional memory arguments at execution time. See the :ref:`quantization guide <doxid-dev_guide_attributes_quantization_1dgaq_execution>` for details.
...
* Direct. The convolution operation is computed directly using SIMD instructions. This is the algorithm used for the most shapes and supports ``s8`` / ``u8``, ``f32``, ``bf16``, ``f16``, ``f8_e5m2``, and ``f64`` data types.
...
* Implicit GEMM. The convolution operation is reinterpreted in terms of matrix-matrix multiplication by rearranging the source data into a :ref:`scratchpad memory <doxid-dev_guide_attributes_scratchpad>`. This is a fallback algorithm that is dispatched automatically when other implementations are not available. GEMM convolution supports the ``s8`` / ``u8``, ``f32``, and ``bf16`` data types.
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Convolution examples are listed in the :ref:`Convolution Operations <doxid-dev_guide_examples_1examples_convolution>` section.
