...
const impl_list_map_t &regular_fp8_impl_list_map() {
    static const impl_list_map_t the_map = REG_REORDER_P({
        ...
        {{f8_e4m3, data_type::undef, 0}, {
            ...
            DNNL_X64_ONLY(REG_SR(f8_e4m3, any, f8_e4m3, any, fmt_order::any, spec::reference))
            DNNL_X64_ONLY(REG_SR(f8_e4m3, any, f16, any, fmt_order::any, spec::reference))
            DNNL_X64_ONLY(REG_SR(f8_e4m3, any, bf16, any, fmt_order::any, spec::reference))
            DNNL_X64_ONLY(REG_SR(f8_e4m3, any, f32, any, fmt_order::any, spec::reference))
