...
Similarly, some primitives support OFP8-compliant FP8 types (8-bit
...
8 bits with FP8 enables faster computation and reduced memory usage.
...
- FP8 example with annotations: @ref fp8_matmul_scaling_cpp
