...
.. ref-code-block:: cpp
	...
	:ref:`engine <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1aad1943a9fd6d3d7ee1e6af41a5b0d3e7>` eng(validate_engine_kind(engine::kind::gpu), 0);
...
.. ref-code-block:: cpp
	...
	cl_kernel ocl_init_kernel = create_init_opencl_kernel(
	        :ref:`ocl_interop::get_context <doxid-namespacednnl_1_1ze__interop_1af1b31375baf405c74d4d4e223ed828af>`(eng), kernel_name, ocl_code);
