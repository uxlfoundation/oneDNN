...
#ifndef GPU_INTEL_GEMM_XE_SYSTOLIC_COPY_KERNEL_HPP
#define GPU_INTEL_GEMM_XE_SYSTOLIC_COPY_KERNEL_HPP
...
struct xe_systolic_copy_kernel_t {
    status_t init(compute::gpu_arch_t arch, data_type_t dt, int unroll_n,
        ...
        *this = {};
        ...
        require_large_buffers_ = require_large_buffers;
    ...
    status_t init_kernel_ctx(compute::kernel_ctx_t &kernel_ctx) const {
        return init_kernel_ctx(kernel_ctx, arch_, dt_, unroll_n_, copyb_,
                trans_, sum_, clear_sum_, require_large_buffers_);
    }
