...
:math:`\srclayerattention`                                  DNNL_ARG_AUGRU_ATTENTION           Input          
...
:math:`\workspace`                                          DNNL_ARG_WORKSPACE                 Input/Output   
:math:`\diffsrclayer`                                       DNNL_ARG_DIFF_SRC_LAYER            Output         
:math:`\diffsrclayerattention`                              DNNL_ARG_DIFF_AUGRU_ATTENTION      Output         
