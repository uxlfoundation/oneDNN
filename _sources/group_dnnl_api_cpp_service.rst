...
.. _doxid-group__dnnl__api__cpp__service:
...
A set of functions that aid in oneDNN debugging and profiling. :ref:`More...<details-group__dnnl__api__cpp__service>`
...
.. ref-code-block:: cpp
	...
	typedef :ref:`dnnl_version_t<doxid-structdnnl__version__t>` :ref:`dnnl::version_t<doxid-group__dnnl__api__cpp__service_1ga7b6ec8722f5ad94170755b8be0cdd3af>`;

	// enums

	enum :ref:`dnnl::cpu_isa<doxid-group__dnnl__api__cpp__service_1gabad017feb1850634bf3babdb68234f83>`;
	enum :ref:`dnnl::cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1gaf574021058ebc6965da14fc4387dd0c4>`;
	enum :ref:`dnnl::status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>`;

	// global functions

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_verbose<doxid-group__dnnl__api__cpp__service_1ga37bcab6f832df551a9fc418e48743b15>`(int level);
	bool :ref:`dnnl::verbose_profiling_enabled<doxid-group__dnnl__api__cpp__service_1ga9d2e01f952b124acd6b8a1e5e9e978f4>`();
	const :ref:`version_t<doxid-group__dnnl__api__cpp__service_1ga7b6ec8722f5ad94170755b8be0cdd3af>`* :ref:`dnnl::version<doxid-group__dnnl__api__cpp__service_1gaad8292408620d0296f22bdf65afb752d>`();
	:ref:`fpmath_mode<doxid-group__dnnl__api__cpp__fpmath__mode_1ga0ad94cbef13dce222933422bfdcfa725>` :ref:`dnnl::get_default_fpmath_mode<doxid-group__dnnl__api__cpp__service_1ga782a2388fc46e80deac409110886db75>`();
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_default_fpmath_mode<doxid-group__dnnl__api__cpp__service_1ga0d55da5f92d60a7324cfdc97004ad975>`(:ref:`fpmath_mode<doxid-group__dnnl__api__cpp__fpmath__mode_1ga0ad94cbef13dce222933422bfdcfa725>` mode);
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_jit_dump<doxid-group__dnnl__api__cpp__service_1ga2344639528a341878d2ce46fe1c1ac83>`(int enable);
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_jit_profiling_flags<doxid-group__dnnl__api__cpp__service_1ga966c54ccb1d9ff33d20c4ea47e34675d>`(unsigned flags);
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_jit_profiling_jitdumpdir<doxid-group__dnnl__api__cpp__service_1ga533341aaf1402e27d1225d1a59819a62>`(const std::string& dir);
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_max_cpu_isa<doxid-group__dnnl__api__cpp__service_1ga08734310b5f1ca794c64b6a5b944b698>`(:ref:`cpu_isa<doxid-group__dnnl__api__cpp__service_1gabad017feb1850634bf3babdb68234f83>` isa);
	:ref:`cpu_isa<doxid-group__dnnl__api__cpp__service_1gabad017feb1850634bf3babdb68234f83>` :ref:`dnnl::get_effective_cpu_isa<doxid-group__dnnl__api__cpp__service_1ga3953f71c3f0126d9cc005a1ceff65e8b>`();
	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` :ref:`dnnl::set_cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1ga29aa5fb708d803e091ac61dc67f9e6ed>`(:ref:`cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1gaf574021058ebc6965da14fc4387dd0c4>` isa_hints);
	:ref:`cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1gaf574021058ebc6965da14fc4387dd0c4>` :ref:`dnnl::get_cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1ga8bee13aa79a9711489b401e9c4252ff2>`();

.. _details-group__dnnl__api__cpp__service:
...
.. _doxid-group__dnnl__api__cpp__service_1ga7b6ec8722f5ad94170755b8be0cdd3af:
...
.. _doxid-group__dnnl__api__cpp__service_1ga37bcab6f832df551a9fc418e48743b15:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_verbose(int level)
...
.. index:: pair: function; verbose_profiling_enabled
.. _doxid-group__dnnl__api__cpp__service_1ga9d2e01f952b124acd6b8a1e5e9e978f4:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	bool dnnl::verbose_profiling_enabled()
...
``true`` if verbose profiling is enabled and ``false`` otherwise.

.. index:: pair: function; version
.. _doxid-group__dnnl__api__cpp__service_1gaad8292408620d0296f22bdf65afb752d:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`version_t<doxid-group__dnnl__api__cpp__service_1ga7b6ec8722f5ad94170755b8be0cdd3af>`* dnnl::version()
...
.. _doxid-group__dnnl__api__cpp__service_1ga782a2388fc46e80deac409110886db75:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`fpmath_mode<doxid-group__dnnl__api__cpp__fpmath__mode_1ga0ad94cbef13dce222933422bfdcfa725>` dnnl::get_default_fpmath_mode()
...
.. _doxid-group__dnnl__api__cpp__service_1ga0d55da5f92d60a7324cfdc97004ad975:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_default_fpmath_mode(:ref:`fpmath_mode<doxid-group__dnnl__api__cpp__fpmath__mode_1ga0ad94cbef13dce222933422bfdcfa725>` mode)
...
.. _doxid-group__dnnl__api__cpp__service_1ga2344639528a341878d2ce46fe1c1ac83:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_jit_dump(int enable)
...
.. _doxid-group__dnnl__api__cpp__service_1ga966c54ccb1d9ff33d20c4ea47e34675d:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_jit_profiling_flags(unsigned flags)
...
.. _doxid-group__dnnl__api__cpp__service_1ga533341aaf1402e27d1225d1a59819a62:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_jit_profiling_jitdumpdir(const std::string& dir)
...
.. _doxid-group__dnnl__api__cpp__service_1ga08734310b5f1ca794c64b6a5b944b698:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_max_cpu_isa(:ref:`cpu_isa<doxid-group__dnnl__api__cpp__service_1gabad017feb1850634bf3babdb68234f83>` isa)
...
.. _doxid-group__dnnl__api__cpp__service_1ga3953f71c3f0126d9cc005a1ceff65e8b:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`cpu_isa<doxid-group__dnnl__api__cpp__service_1gabad017feb1850634bf3babdb68234f83>` dnnl::get_effective_cpu_isa()
...
.. _doxid-group__dnnl__api__cpp__service_1ga29aa5fb708d803e091ac61dc67f9e6ed:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`status<doxid-group__dnnl__api__cpp__service_1ga7acc4d3516304ae68a1289551d8f2cdd>` dnnl::set_cpu_isa_hints(:ref:`cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1gaf574021058ebc6965da14fc4387dd0c4>` isa_hints)
...
.. _doxid-group__dnnl__api__cpp__service_1ga8bee13aa79a9711489b401e9c4252ff2:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`cpu_isa_hints<doxid-group__dnnl__api__cpp__service_1gaf574021058ebc6965da14fc4387dd0c4>` dnnl::get_cpu_isa_hints()
