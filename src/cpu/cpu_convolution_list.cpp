...
const std::map<pk_dt_impl_key_t, std::vector<impl_list_item_t>> &impl_list_map() {
    static const std::map<pk_dt_impl_key_t, std::vector<impl_list_item_t>> the_map = REG_CONV_P({
        ...
        {{forward, "f32:xf:*"}, {
            ...
            CPU_INSTANCE_AARCH64(jit_uni_dw_convolution_fwd_t<sve_512>)
            CPU_INSTANCE_AARCH64(jit_uni_dw_convolution_fwd_t<sve_256>)
            CPU_INSTANCE_AARCH64(jit_uni_dw_convolution_fwd_t<sve_128>)
            CPU_INSTANCE_AARCH64(jit_uni_dw_convolution_fwd_t<asimd>)
