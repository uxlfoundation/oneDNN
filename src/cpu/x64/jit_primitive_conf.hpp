...
struct jit_uni_resampling_args_t {
    dim_t batch_of_sp_points_to_process = 0;
    ...
    dim_t src_offset_top = 0;
    dim_t src_offset_bottom = 0;
    dim_t src_offset_front = 0;
    dim_t src_offset_back = 0;
