...
void sme2_interleaved_nomerge_fp16_mopa_2VLx1VL(const __fp16 *const A, const __fp16 *const B, __fp16 *const C, int ldc, const int M, const int N, const int K, const __fp16 *const bias, const Activation act, bool accumulate, __fp16 *const accumulator_buffer)
{
  struct KernelArgs
  {
    KernelArgs(
  ...
  __asm__ __volatile__(
      ...
      "cbz x20, 6f\n"
      "fmov z12.h, #1.0\n"
      "ld1h { z13.h }, p0/Z, [x20, x13, LSL #1]\n"
      ".inst 0x818d2588  // fmopa za0.h, p1/M, p1/M, z12.h, z13.h\n"
      ".inst 0x818d2589  // fmopa za1.h, p1/M, p1/M, z12.h, z13.h\n"
      ...
      "ble 8f\n"
      "7:"  // K loop
      ".inst 0x81802588  // fmopa za0.h, p1/M, p1/M, z12.h, z0.h\n"
      "subs x21, x21, #0x1\n"
      ".inst 0x818025a9  // fmopa za1.h, p1/M, p1/M, z13.h, z0.h\n"
      ".inst 0x818125c8  // fmopa za0.h, p1/M, p1/M, z14.h, z1.h\n"
      ".inst 0x818125e9  // fmopa za1.h, p1/M, p1/M, z15.h, z1.h\n"
      ".inst 0xa040a36c  // ld1h { z12.h-z15.h }, pn8.b/Z, [x27]\n"
      ".inst 0x81822648  // fmopa za0.h, p1/M, p1/M, z18.h, z2.h\n"
      ".inst 0x818226c9  // fmopa za1.h, p1/M, p1/M, z22.h, z2.h\n"
      ".inst 0x81832748  // fmopa za0.h, p1/M, p1/M, z26.h, z3.h\n"
      ".inst 0x818327c9  // fmopa za1.h, p1/M, p1/M, z30.h, z3.h\n"
      ".inst 0xa141a372  // ld1h { z18.h, z22.h, z26.h, z30.h }, pn8.b/Z, [x27, #0x4, MUL VL]\n"
      "addvl x27, x27, #8\n"
      ".inst 0xa040a380  // ld1h { z0.h-z3.h }, pn8.b/Z, [x28]\n"
      "addvl x28, x28, #4\n"
      ...
      "ld1h { z1.h }, p1/Z, [x28]\n"
      "addvl x28, x28, #1\n"
      ".inst 0x81812748  // fmopa za0.h, p1/M, p1/M, z26.h, z1.h\n"
      ".inst 0x81812769  // fmopa za1.h, p1/M, p1/M, z27.h, z1.h\n"
      "bgt 10b\n"
      "11:"  // K oddments: End
      "tbz x8, #1, 15f\n"
      "tbz x8, #0, 13f\n"
