...
xe_wino_wei_transform(__global DATA_T *U, const __global DATA_T *weights) {
...
__attribute__((intel_reqd_sub_group_size(LWX))) __kernel void
xe_wino_conv_fwd(__global DATA_T *dst, const __global DATA_T *src,
