...
Argument                                                    Index                               Type           
==========================================================  ==================================  =============  
:math:`\srclayer`                                           DNNL_ARG_SRC_LAYER                  Input          
:math:`\srclayerattention`                                  DNNL_ARG_SRC_LAYER_ATTENTION        Input          
:math:`\srciter`                                            DNNL_ARG_SRC_ITER                   Input          
:math:`\srciterc`                                           DNNL_ARG_SRC_ITER_C                 Input          
:math:`\weightslayer`                                       DNNL_ARG_WEIGHTS_LAYER              Input          
:math:`\weightsiter`                                        DNNL_ARG_WEIGHTS_ITER               Input          
:math:`\weightspeephole`                                    DNNL_ARG_WEIGHTS_PEEPHOLE           Input          
:math:`\weightsprojection`                                  DNNL_ARG_WEIGHTS_PROJECTION         Input          
:math:`\bias`                                               DNNL_ARG_BIAS                       Input          
:math:`\dstlayer`                                           DNNL_ARG_DST_LAYER                  Output         
:math:`\dstiter`                                            DNNL_ARG_DST_ITER                   Output         
:math:`\dstiterc`                                           DNNL_ARG_DST_ITER_C                 Output         
:math:`\workspace`                                          DNNL_WORKSPACE                      Input/Output   
:math:`\diffsrclayer`                                       DNNL_ARG_DIFF_SRC_LAYER             Output         
:math:`\diffsrclayerattention`                              DNNL_ARG_DIFF_SRC_LAYER_ATTENTION   Output         
:math:`\diffsrciter`                                        DNNL_ARG_DIFF_SRC_ITER              Output         
:math:`\diffsrciterc`                                       DNNL_ARG_DIFF_SRC_ITER_C            Output         
:math:`\diffweightslayer`                                   DNNL_ARG_DIFF_WEIGHTS_LAYER         Output         
:math:`\diffweightsiter`                                    DNNL_ARG_DIFF_WEIGHTS_ITER          Output         
:math:`\diffweightspeephole`                                DNNL_ARG_DIFF_WEIGHTS_PEEPHOLE      Output         
:math:`\diffweightsprojection`                              DNNL_ARG_DIFF_WEIGHTS_PROJECTION    Output         
:math:`\diffbias`                                           DNNL_ARG_DIFF_BIAS                  Output         
:math:`\diffdstlayer`                                       DNNL_ARG_DIFF_DST_LAYER             Input          
:math:`\diffdstiter`                                        DNNL_ARG_DIFF_DST_ITER              Input          
:math:`\diffdstiterc`                                       DNNL_ARG_DIFF_DST_ITER_C            Input          
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. RNN examples are listed in the :ref:`Recurrent Neural Networks <doxid-dev_guide_examples_1examples_rnn>` section.
