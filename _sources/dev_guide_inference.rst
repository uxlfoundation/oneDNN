...
Use the :ref:`dnnl::prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>` argument at creation of the primitive descriptor, as in this convolution example:
...
To accomplish this propagation in a robust manner, it is recommended to follow these steps:
...
.. ref-code-block:: cpp
	...
	if (conv_prim_descr.src_desc() != user_source_memory.get_desc()) {
	    conv_source_memory = memory(conv_prim_descr.src_desc(), :ref:`engine <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1aad1943a9fd6d3d7ee1e6af41a5b0d3e7>`);
...
Create a convolution primitive descriptor, passing the post-op infused ``attrs`` as an argument
