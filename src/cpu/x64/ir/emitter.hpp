...
#ifndef CPU_X64_IR_EMITTER_HPP
#define CPU_X64_IR_EMITTER_HPP
...
// (afrer postamble). For example: avx2 mask tables.
//
...
//
// Most ISA-specific details are handled by the `emit_*` functions, so
// supporting another target ISA mainly requires providing a similar lowering
// implementation or extending the existing one.
//
...
//
// This is the main entry point for the emitter. It dispatches the ISA-specific
// emitter.
