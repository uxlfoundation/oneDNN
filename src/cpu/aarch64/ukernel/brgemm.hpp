...
#ifndef CPU_AARCH64_UKERNEL_BRGEMM_HPP
#define CPU_AARCH64_UKERNEL_BRGEMM_HPP
...
struct dnnl_brgemm : public dnnl::impl::c_compatible {
    ...
    dnnl::impl::status_t inline set_hw_context() const {
...
status_t inline dnnl_brgemm_set_hw_context(const dnnl_brgemm *brgemm) {
    return dnnl::impl::status::success;
};

status_t inline dnnl_brgemm_release_hw_context() {
    return dnnl::impl::status::success;
};
