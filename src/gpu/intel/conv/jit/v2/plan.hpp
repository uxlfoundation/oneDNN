...
#ifndef GPU_INTEL_CONV_JIT_V2_PLAN_HPP
#define GPU_INTEL_CONV_JIT_V2_PLAN_HPP
...
struct fma_plan_t : public base_plan_t {
    v2::layout_t a_layout;
    v2::layout_t b_layout;
    v2::layout_t c_layout;
    tile_t inst_tile;
