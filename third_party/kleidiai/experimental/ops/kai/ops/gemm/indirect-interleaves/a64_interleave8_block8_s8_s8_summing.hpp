//
// SPDX-FileCopyrightText: Copyright 2019-2021, 2023-2024, 2026 Arm Limited and/or its affiliates <open-source-office@arm.com>
//
...
)
{
  __asm__ __volatile__(
      ...
      : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28"
    );
}
