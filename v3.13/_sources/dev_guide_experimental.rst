...
More details are available in the [Grouped Memory Format section](:ref:`Grouped Memory Format for Variable-Size Batching <doxid-dev_guide_grouped_mem>`) and :ref:`MatMul Grouped GEMM section <doxid-dev_guide_matmul_1dev_guide_matmul_grouped_gemm>`.
