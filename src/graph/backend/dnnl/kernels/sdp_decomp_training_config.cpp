...
impl::status_t sdp_decomp_training_config_t::construct_params(
    ...
    memory::desc sub_src1_md, sub_wei1_user_md, sub_mm1_src_md, sub_mm1_wei_md,
            sub_mm1_dst_md, sub_wei2_user_md, sub_mm2_wei_md, sub_mm2_dst_md,
            sub_dst_md, sub_dst_user_md;
    ...
    CHECK(sub_mm1_prim.init(p_engine, sub_src1_md, sub_src1_d_md,
            ...
            primitive_attr {}, sub_mm1_dst_md, sub_matmul1_attr));
    ...
    CHECK(sub_reorder1.init(p_engine, sub_wei1_user_md, sub_mm1_wei_md,
            primitive_attr {}, key_plan.needs_reorder));
    ...
    CHECK(sub_mm2_prim.init(p_engine, sub_mm2_src_md, sub_wei2_user_md,
            sub_wei2_d_md, primitive_attr {}, sub_dst_user_md, sub_dst_md,
    ...
    CHECK(sub_reorder2.init(p_engine, sub_wei2_user_md, sub_mm2_wei_md,
            primitive_attr {}, value_plan.needs_reorder));
