...
brgemm_matmul_conf_utils_t::brgemm_matmul_conf_utils_t(
    ...
    , f4_via_convert_dt(utils::one_of(data_type::f4_e2m1, bgmmc.src_dt,
                                bgmmc.wei_dt, bgmmc.dst_dt)
              || (utils::one_of(data_type::f4_e3m0, bgmmc.src_dt, bgmmc.wei_dt,
                          bgmmc.dst_dt)
                      && isa == avx10_1_512))
