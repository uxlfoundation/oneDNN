...
const kcatalog::Entry *select(const kcatalog::Catalog &catalog, const MatchParams &pattern, const EvaluateParams &eparams, EvaluateAuxOutput &aux, std::map<double,const kcatalog::Entry *> &entries,  SelectionObserver *observer = nullptr);
const kcatalog::Entry *select(const kcatalog::Catalog &catalog, int npatterns, const MatchParams *patterns, const EvaluateParams &eparams, EvaluateAuxOutput &aux, std::map<double,const kcatalog::Entry *> &entries,  SelectionObserver *observer = nullptr);
