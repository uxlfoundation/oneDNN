...
| ONEDNN_EXPERIMENTAL_GROUPED_GEMM         | Enable grouped memory format and grouped GEMM for MoE workloads. |
...
### ONEDNN_EXPERIMENTAL_GROUPED_GEMM

This option enables grouped memory format and grouped GEMM primitive support
