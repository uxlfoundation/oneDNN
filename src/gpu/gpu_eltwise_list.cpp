...
#include "gpu/intel/gen9_eltwise.hpp"
#include "gpu/intel/ref_eltwise.hpp"
#endif
...
const std::map<pk_impl_key_t, std::vector<impl_list_item_t>>
    ...
    {{forward}, {
        GPU_INSTANCE_INTEL(intel::gen9_eltwise_fwd_t)
        GPU_INSTANCE_INTEL(intel::ref_eltwise_fwd_t)
    ...
    {{backward}, REG_BWD_PK({
        GPU_INSTANCE_INTEL(intel::gen9_eltwise_bwd_t)
        GPU_INSTANCE_INTEL(intel::ref_eltwise_bwd_t)
