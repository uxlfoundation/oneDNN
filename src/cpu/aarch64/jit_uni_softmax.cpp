...
struct jit_softmax_base_t : public jit_generator {
    ...
    std::unique_ptr<jit_uni_eltwise_injector_f32<sve_128>> exp_injector_;
    std::unique_ptr<jit_uni_eltwise_injector_f32<sve_128>> log_injector_;
...
#undef PARAM_LOAD
    ...
    void generate() override {
        ...
        if (pd_->is_fwd() && is_logsoftmax_) {
            log_injector_.reset(new jit_uni_eltwise_injector_f32<sve_128>(this,
