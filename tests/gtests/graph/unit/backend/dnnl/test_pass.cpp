...
TEST(test_pass, InputJsonIsValid) {
    ...
    */
    ...
    dnnl::impl::dnnl_ostringstream_t valid_stream;
    ...
    dnnl::impl::dnnl_istringstream_t valid_is(valid_str);
...
TEST(test_pass, InputJsonIsInvalidWithIncompleteHash) {
    ...
    */
    ...
    dnnl::impl::dnnl_ostringstream_t invalid_stream;
    std::string version = std::to_string(dnnl_version()->major) + "."
            + std::to_string(dnnl_version()->minor) + "."
            + std::to_string(dnnl_version()->patch);
    invalid_stream << "{\n"
    ...
    dnnl::impl::dnnl_istringstream_t invalid_is;
    invalid_is.str(invalid_str);
