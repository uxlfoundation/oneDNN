...
When passed to a primitive descriptor creation, the :ref:`dnnl::rounding_mode <doxid-group__dnnl__api__cpp__attributes_1ga0ddf600480e2014503ce39429a7d0d7f>` primitive attribute specifies which rounding mode to use when a given argument is down-converted.

The :ref:`dnnl::rounding_mode <doxid-group__dnnl__api__cpp__attributes_1ga0ddf600480e2014503ce39429a7d0d7f>` primitive attribute accepts:
