...
object_t pexpr_t::_mutate(ir_mutator_t &mutator) const {
    return static_cast<pexpr_mutator_t &>(mutator)._mutate(*this);
}
...
void nary_op_t::_visit(ir_visitor_t &visitor) const {
    static_cast<nary_op_visitor_t &>(visitor)._visit(*this);
}
...
object_t nary_op_t::_mutate(ir_mutator_t &mutator) const {
    return static_cast<nary_op_mutator_t &>(mutator)._mutate(*this);
}
