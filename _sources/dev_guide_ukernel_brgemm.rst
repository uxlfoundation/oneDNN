...
.. note:: 
   ...
   to optimize multithreaded performance, align memory for A/B offset and scratchpad buffers so that cache lines are not shared between threads.
