...
.. math::
	...
	{dst}_{0,\cdots,\cdots} = \max\{src_{i,\cdots,\cdots}\} ,i \in [0,channelNum-1]
...
.. note:: 
   ...
   The result of ReduceMax function applied to src tensor. shape[i] = shapeOf[data](i) for all i that is not in the list of axes from the second input. For dimensions from axes, shape[i] == 1 if keep_dims == True, or i-th dimension is removed from the dst otherwise.
