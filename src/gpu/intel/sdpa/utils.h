...
#define KEY_OFFSETS \
    const off_t KEY_S0, const off_t KEY_S1, const off_t KEY_S2, \
            const off_t KEY_S3, const off_t KEY_D3
#define QRY_OFFSETS \
    const off_t QRY_S0, const off_t QRY_S1, const off_t QRY_S2, \
            const off_t QRY_D3
#define VAL_OFFSETS const off_t VAL_S0, const off_t VAL_S1, const off_t VAL_S2
#define DST_OFFSETS \
    const off_t DST_S0, const off_t DST_S1, const off_t DST_S2, \
            const off_t DST_D1
#define MSK_OFFSETS \
    const off_t MSK_S0, const off_t MSK_S1, const off_t MSK_S2, \
            const off_t MSK_D0, const off_t MSK_D1
