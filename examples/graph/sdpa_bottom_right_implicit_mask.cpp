...
void bench_sdpa(engine::kind ekind, logical_tensor::data_type dt,
    ...
    */
    ...
    auto gen_index_row_out_lt = logical_tensor(id++, data_type::s32, score_sz, layout_type::strided);
    ...
    auto gen_index_col_out_lt = logical_tensor(id++, data_type::s32, score_sz, layout_type::strided);
    ...
    auto mask_ge_out_lt = logical_tensor(id++, data_type::boolean, score_sz, layout_type::strided); 
    ...
    auto masked_score = logical_tensor(id++, dt, score_sz, layout_type::strided);
...
void bench(engine::kind ekind, dnnl_data_type_t dt,
        const sdpa_dims_t &p, double time_limit = 0.) {
    try {
        bench_sdpa(ekind, static_cast<data_type>(dt), p,
                time_limit);
        get_mem_pool().clear();
    } catch (dnnl::error &e) {
