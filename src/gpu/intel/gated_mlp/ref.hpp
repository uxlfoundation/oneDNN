    ...
    struct pd_t : public gated_mlp_pd_t {
        ...
        status_t init(const impl::engine_t *engine) {
            ...
            CHECK(gate_attr.post_ops_.append_binary(
                    alg_kind::binary_mul_inplace, &gate_dst_md));
            ...
            VDISPATCH_GATED_MLP_SC(
                    impl::create_matmul_pd(gemm_up_pd_, engine,
                            arg_md(DNNL_ARG_SRC), arg_md(DNNL_ARG_WEIGHTS_UP),
                            nullptr, &gate_dst_md, &up_attr),
            ...
            VDISPATCH_GATED_MLP_SC(
                    impl::create_matmul_pd(gemm_down_pd_, engine, &gate_dst_md,
                            arg_md(DNNL_ARG_WEIGHTS_DOWN), nullptr,
                            arg_md(DNNL_ARG_DST), &down_attr),
