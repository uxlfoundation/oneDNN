...
// This a regression test for PVC write-after-read hardware bug workaround. The
// bug manifests as a page fault caused by WAR-related corruption of the send
// header. The test doesn't include any validation, the expected failure is a
// GPU page fault and test segfault.
