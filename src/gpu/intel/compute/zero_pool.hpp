...
class zero_pool_t {
public:
    zero_pool_t(compute::engine_t *engine, size_t chunk_size,
            bool stream_private = false, bool in_order = false);

    status_t init();

    status_t claim(compute::stream_t *stream, size_t len,
...
private:
    compute::engine_t *engine_ = nullptr;
    ...
    status_t claim_unpooled(compute::stream_t *stream, size_t len,
