...
:math:`\diffsrc_1`                                          DNNL_ARG_DIFF_SRC_1   Output         
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Batch normalization examples are listed in the :ref:`Normalization Primitives <doxid-dev_guide_examples_1examples_normalization>` section.
