...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	void compute_attention(float *context_vectors, dim_t src_seq_length_max,
	        dim_t batch, dim_t feature_size, float weights_src_layer_scale,
	        int32_t *compensation, float dec_src_layer_scale,
	        float dec_src_layer_shift, uint8_t *annotations,
	        float *weighted_annotations, const :ref:`memory <doxid-structdnnl_1_1memory>` &src_u8_mem,
	        const :ref:`memory <doxid-structdnnl_1_1memory>` &wei_s8_mem, const :ref:`memory <doxid-structdnnl_1_1memory>` &dst_s32_mem,
	        const :ref:`matmul <doxid-structdnnl_1_1matmul>` &matmul_int8_prim, const :ref:`memory <doxid-structdnnl_1_1memory>` &src_gemv_mem,
	        const :ref:`memory <doxid-structdnnl_1_1memory>` &wei_gemv_mem, const :ref:`memory <doxid-structdnnl_1_1memory>` &dst_gemv_mem,
	        const :ref:`matmul <doxid-structdnnl_1_1matmul>` &matmul_gemv_prim, :ref:`stream <doxid-structdnnl_1_1stream>` &strm) {
	    // dst_iter : (n, c) matrix
	    ...
	    matmul_int8_prim.:ref:`execute <doxid-structdnnl_1_1primitive_1a2c112f2449a18a87310dee2ecd8c64eb>`(strm,
	            {{:ref:`DNNL_ARG_SRC <doxid-group__dnnl__api__primitives__common_1gac37ad67b48edeb9e742af0e50b70fe09>`, src_u8_mem}, {:ref:`DNNL_ARG_WEIGHTS <doxid-group__dnnl__api__primitives__common_1gaf279f28c59a807e71a70c719db56c5b3>`, wei_s8_mem},
	                    {:ref:`DNNL_ARG_DST <doxid-group__dnnl__api__primitives__common_1ga3ca217e4a06d42a0ede3c018383c388f>`, dst_s32_mem}});
	    ...
	    matmul_gemv_prim.:ref:`execute <doxid-structdnnl_1_1primitive_1a2c112f2449a18a87310dee2ecd8c64eb>`(strm,
	            {{:ref:`DNNL_ARG_SRC <doxid-group__dnnl__api__primitives__common_1gac37ad67b48edeb9e742af0e50b70fe09>`, src_gemv_mem}, {:ref:`DNNL_ARG_WEIGHTS <doxid-group__dnnl__api__primitives__common_1gaf279f28c59a807e71a70c719db56c5b3>`, wei_gemv_mem},
	                    {:ref:`DNNL_ARG_DST <doxid-group__dnnl__api__primitives__common_1ga3ca217e4a06d42a0ede3c018383c388f>`, dst_gemv_mem}});
	    strm.:ref:`wait <doxid-structdnnl_1_1stream_1a59985fa8746436057cf51a820ef8929c>`();
	...
	void simple_net() {
	    ...
	    try {
	        enc_bidir_prim_desc = :ref:`lstm_forward::primitive_desc <doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`(cpu_engine,
	                :ref:`prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>`,
	                :ref:`rnn_direction::bidirectional_concat <doxid-group__dnnl__api__cpp__rnn_1gga33315cf335d1cbe26fd6b70d956e23d5a7a1bb9f8699e8c03cbe4bd681fb50830>`, enc_bidir_src_layer_md,
	    ...
	    auto enc_uni_first_prim_desc = :ref:`lstm_forward::primitive_desc <doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`(cpu_engine,
	            :ref:`prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>`,
	            :ref:`rnn_direction::unidirectional_left2right <doxid-group__dnnl__api__cpp__rnn_1gga33315cf335d1cbe26fd6b70d956e23d5a04f4bf4bc6a47e30f0353597e244c44a>`, enc_bidir_dst_layer_md,
	    ...
	    auto enc_uni_prim_desc = :ref:`lstm_forward::primitive_desc <doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`(cpu_engine,
	            :ref:`prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>`,
	            :ref:`rnn_direction::unidirectional_left2right <doxid-group__dnnl__api__cpp__rnn_1gga33315cf335d1cbe26fd6b70d956e23d5a04f4bf4bc6a47e30f0353597e244c44a>`,
	    ...
	    auto dec_ctx_prim_desc = :ref:`lstm_forward::primitive_desc <doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`(cpu_engine,
	            :ref:`prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>`,
	            :ref:`rnn_direction::unidirectional_left2right <doxid-group__dnnl__api__cpp__rnn_1gga33315cf335d1cbe26fd6b70d956e23d5a04f4bf4bc6a47e30f0353597e244c44a>`, dec_src_layer_md,
	    ...
	    auto :ref:`src_md <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a90a729e395453e1d9411ad416c796819>` = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`(
	    ...
	    auto wei_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`(
	    ...
	    auto :ref:`dst_md <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a701158248eed4e5fc84610f2f6026493>` = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`(
	    ...
	    auto matmul_pd = :ref:`matmul::primitive_desc <doxid-structdnnl_1_1matmul_1_1primitive__desc>`(cpu_engine, src_md, wei_md, dst_md);
	    auto matmul_prim = :ref:`matmul <doxid-structdnnl_1_1matmul>`(matmul_pd);
	    auto src_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(
	            src_md, cpu_engine, enc_dst_layer_memory.get_data_handle());
	    auto wei_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(wei_md, cpu_engine, user_weights_annotation.data());
	    auto dst_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(dst_md, cpu_engine, weighted_annotations.data());
	
	    auto att_src_u8_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({batch, feature_size},
	            :ref:`memory::data_type::u8 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea077393852be20e37026d6281827662f2>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto att_wei_s8_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({feature_size, feature_size},
	            :ref:`memory::data_type::s8 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea3e8d88fdd85d7153525e0647cdd97686>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto att_dst_s32_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({batch, feature_size},
	            :ref:`memory::data_type::s32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dceaa860868d23f3a68323a2e3f6563d7f31>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto matmul_int8_pd = :ref:`matmul::primitive_desc <doxid-structdnnl_1_1matmul_1_1primitive__desc>`(
	            cpu_engine, att_src_u8_md, att_wei_s8_md, att_dst_s32_md);
	    auto matmul_int8_prim = :ref:`matmul <doxid-structdnnl_1_1matmul>`(matmul_int8_pd);
	
	    auto src_u8_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_int8_pd.src_desc(), cpu_engine,
	            dec_src_layer_memory.:ref:`get_data_handle <doxid-structdnnl_1_1memory_1a24aaca8359e9de0f517c7d3c699a2209>`());
	    auto wei_s8_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_int8_pd.weights_desc(), cpu_engine,
	            user_weights_attention_src_layer.data());
	    auto dst_s32_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(
	            matmul_int8_pd.dst_desc(), cpu_engine, weighted_src_layer.data());
	
	    auto att_src_gemv_md
	            = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({num_weighted_annotations, feature_size},
	                    :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto att_wei_gemv_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`(
	            {feature_size, 1}, :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto att_dst_gemv_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({num_weighted_annotations, 1},
	            :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto matmul_gemv_pd = :ref:`matmul::primitive_desc <doxid-structdnnl_1_1matmul_1_1primitive__desc>`(
	            cpu_engine, att_src_gemv_md, att_wei_gemv_md, att_dst_gemv_md);
	    auto matmul_gemv_prim = :ref:`matmul <doxid-structdnnl_1_1matmul>`(matmul_gemv_pd);
	    auto src_gemv_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(
	            matmul_gemv_pd.src_desc(), cpu_engine, alignment_model.data());
	    auto wei_gemv_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_gemv_pd.weights_desc(), cpu_engine,
	            user_weights_alignments.data());
	    auto dst_gemv_mem
	            = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_gemv_pd.dst_desc(), cpu_engine, alignments.data());
	    ...
	    auto :ref:`execute <doxid-namespacednnl_1_1graph_1_1ocl__interop_1a8b1d57febf09dc0621d7aa2a8dc13035>` = [&]() {
	        ...
	        matmul_prim.execute(s,
	                {{:ref:`DNNL_ARG_SRC <doxid-group__dnnl__api__primitives__common_1gac37ad67b48edeb9e742af0e50b70fe09>`, src_mem}, {:ref:`DNNL_ARG_WEIGHTS <doxid-group__dnnl__api__primitives__common_1gaf279f28c59a807e71a70c719db56c5b3>`, wei_mem},
	        ...
	        for (dim_t i = 0; i < tgt_seq_length_max; i++) {
	            ...
	            src_u8_mem.:ref:`set_data_handle <doxid-structdnnl_1_1memory_1a34d1c7dbe9c6302b197f22c300e67aed>`(src_att_layer_handle);
	            //[att ctx]
	            compute_attention(src_att_iter_handle, src_seq_length_max, batch,
	                    feature_size, weights_attention_scale,
	                    weights_attention_sum_rows.data(), data_scale, data_shift,
	                    (uint8_t *)enc_bidir_dst_layer_memory.get_data_handle(),
	                    weighted_annotations.data(), src_u8_mem, wei_s8_mem,
	                    dst_s32_mem, matmul_int8_prim, src_gemv_mem, wei_gemv_mem,
	                    dst_gemv_mem, matmul_gemv_prim, s);
	            //[att ctx]
