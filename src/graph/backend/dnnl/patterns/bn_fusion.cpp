...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(dnnl, fp_bn_relu)
        .set_priority(8.8f)
...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(dnnl, x8_bn)
        .set_priority(9.f)
        .set_kind(partition_kind_t::batch_norm_post_ops)
        .set_attr<FCreatePattern>("FCreatePattern",
                [](const std::shared_ptr<pb_graph_t> &pgraph) -> void {
...
#if BUILD_TRAINING
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(dnnl, fp_bn_bwd_relu_bwd)
        .set_priority(8.8f)
