...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Resampling examples are listed in the :ref:`Pooling and Sampling <doxid-dev_guide_examples_1examples_pooling>` section.
