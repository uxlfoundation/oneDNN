...
status_t device_info_t::init_runtime_version(impl::engine_t *engine) {
    ...
    func_zeDriverGetProperties(driver, &driver_properties);
...
status_t device_info_t::init_extensions(impl::engine_t *engine) {
    ...
    CHECK(ocloc_get_extensions(extensions));

    std::string extension_string(extensions[0]);
...
status_t device_info_t::init_attributes(impl::engine_t *engine) {
    ...
    CHECK(func_zeDeviceGetComputeProperties(
    ...
    CHECK(func_zeDeviceGetCacheProperties(
    ...
    CHECK(func_zeDeviceGetCacheProperties(device,
    ...
    func_zeDeviceGetMemoryAccessProperties(
