...
Argument                                                    Index                                  Type     
==========================================================  =====================================  =======  
:math:`\src`                                                DNNL_ARG_FROM                          Input    
:math:`\dst`                                                DNNL_ARG_TO                            Output   
:math:`src scale`                                           DNNL_ARG_ATTR_SCALES | DNNL_ARG_FROM   Input    
:math:`dst scale`                                           DNNL_ARG_ATTR_SCALES | DNNL_ARG_TO     Input    
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Reorder examples are listed in the :ref:`Memory Transformations <doxid-dev_guide_examples_1examples_reorder>` section.
