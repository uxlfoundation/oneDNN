...
Argument                                                    Index                   Type     
==========================================================  ======================  =======  
:math:`\src`                                                DNNL_ARG_MULTIPLE_SRC   Input    
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Concat examples are listed in the :ref:`Tensor Operations <doxid-dev_guide_examples_1examples_tensor_operations>` section.
