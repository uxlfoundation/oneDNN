...
const std::map<pk_impl_key_t, std::vector<impl_list_item_t>>
    ...
    {{forward}, {
        ...
        GPU_INSTANCE_REF_INTEL(intel::ocl::ref_inner_product_fwd_t)
    ...
    {{backward}, REG_BWD_PK({
        ...
        GPU_INSTANCE_REF_INTEL(intel::ocl::ref_inner_product_bwd_data_t)
        GPU_INSTANCE_REF_INTEL(intel::ocl::ref_inner_product_bwd_weights_t)
