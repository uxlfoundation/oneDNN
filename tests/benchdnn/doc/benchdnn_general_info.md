...
`DNNL_ARG_*` constants and end with `.bin`. Consider these 3 file names:
* `/path/to/faulty_conv_buffers.1.bin` — this file is for `DNNL_ARG_SRC`
* `/path/to/faulty_conv_buffers.33.bin` — this file is for `DNNL_ARG_WEIGHTS`
* `/path/to/faulty_conv_buffers.41.bin` — this file is for `DNNL_ARG_BIAS`
...
./benchdnn -v2 --conv ...
...
File '/path/to/faulty_conv_buffers.1.bin' successfully processed; buffer imported.
File '/path/to/faulty_conv_buffers.33.bin' successfully processed; buffer imported.
File '/path/to/faulty_conv_buffers.41.bin' successfully processed; buffer imported.
...
```
