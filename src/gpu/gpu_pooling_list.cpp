...
#include "gpu/intel/gen9_global_pooling.hpp"
#include "gpu/intel/gen9_pooling.hpp"
...
const std::map<pk_impl_key_t, std::vector<impl_list_item_t>>
    ...
    {{forward}, {
        ...
        GPU_INSTANCE_INTEL(intel::gen9_global_pooling_fwd_t)
        GPU_INSTANCE_INTEL(intel::gen9_pooling_fwd_t)
    ...
    {{backward}, REG_BWD_PK({
        GPU_INSTANCE_INTEL(intel::gen9_global_pooling_bwd_t)
        GPU_INSTANCE_INTEL(intel::gen9_pooling_bwd_t)
