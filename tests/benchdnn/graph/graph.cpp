...
void skip_unimplemented_partitions(const std::vector<partition> &partitions,
    ...
    bool partition_num_mismatch = (prb->expected_n_partition != 0
...
int doit(const prb_t *prb, res_t *res) {
    ...
    skip_unimplemented_partitions(partitions, dg, prb, end_opid_v, res);
