...
.. toctree::
   ...
   dev_guide_graph_binary_fusion_patterns
   dev_guide_graph_unary_fusion_patterns
   dev_guide_graph_interpolate_fusion_patterns
   dev_guide_graph_reduction_fusion_patterns
   dev_guide_graph_pool_fusion_patterns
   dev_guide_graph_norm_fusion_patterns
   dev_guide_graph_softmax_fusion_patterns
   dev_guide_graph_other_fusion_patterns
...
`Quantize <dev_guide_op_quantize.html>`_,
`StaticReshape <dev_guide_op_staticreshape.html>`_ and
`StaticTranspose <dev_guide_op_statictranspose.html>`_.
