...
.. ref-code-block:: cpp
	...
	struct post_ops: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		void :ref:`append_eltwise<doxid-structdnnl_1_1post__ops_1a60ce0e18ec1ef06006e7d72e7aa865be>`(:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` aalgorithm, float alpha, float beta);
		...
		void :ref:`append_binary<doxid-structdnnl_1_1post__ops_1a40bb2b39a685726ac54873b203be41b5>`(:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` aalgorithm, const :ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src1_desc);
...
Creates post-ops primitive attribute from a C API :ref:`dnnl_post_ops_t <doxid-group__dnnl__api__attributes_1ga7d715ce1a81606584df9dcf045976401>` handle. The resulting handle is not weak and the C handle will be destroyed during the destruction of the C++ object.
...
Appends an accumulation (sum) post-op. Prior to accumulating the result, the previous value will be will be reduced by zero point ``zero_point`` and multiplied by a scaling factor ``scale``.
...
.. ref-code-block:: cpp
	...
	void append_eltwise(:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` aalgorithm, float alpha, float beta)
...
.. ref-code-block:: cpp
	...
	void append_binary(:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` aalgorithm, const :ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src1_desc)
