...
| Convolution Fusions | Fusions related to Convolution and ConvolutionBackwardWeights. Refer to @ref dev_guide_graph_convolution_fusions for more details. |
...
| Interpolate Fusions | Refer to @ref dev_guide_graph_interpolate_fusions for more details. |
...
| Norm Fusions | Fusions related to norm operations like GroupNorm, LayerNorm, BatchNormInference. Refer to @ref dev_guide_graph_norm_fusions for more details. |
...
| Other Fusions | Fusions related to Reorder, StaticReshape, StaticTranspose, Concat, Interpolate, Reciprocal, TypeCast. Refer to @ref dev_guide_graph_other_fusions for more details. |