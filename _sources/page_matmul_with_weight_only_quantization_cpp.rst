...
.. index:: pair: page; MatMul Tutorial: Weight-only Quantization
.. _doxid-matmul_with_weight_only_quantization_cpp:

MatMul Tutorial: Weight-only Quantization
=========================================

C++ API example demonstrating how one can use :ref:`MatMul <doxid-dev_guide_matmul>` with quantized weights.
