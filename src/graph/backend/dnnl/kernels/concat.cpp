...
template <bool quantized>
status_t concat_t<quantized>::execute_impl(const stream_t *stream,
        const std::vector<tensor_t> &inputs,
...
template <bool quantized>
status_t concat_t<quantized>::sycl_execute_impl(const stream_t *stream,
        const std::vector<tensor_t> &inputs,
        const std::vector<tensor_t> &outputs, const tensor_t *scratchpad_buf,
...
template <bool quantized>
status_t concat_t<quantized>::ocl_execute_impl(const stream_t *stream,
        const std::vector<tensor_t> &inputs,
        const std::vector<tensor_t> &outputs, const tensor_t *scratchpad_buf,
