...
| DNNL_EXPERIMENTAL_SELF_SUFFICIENT_L0       | Enable experimental functionality in SYCL to allow the removal of the OpenCL dependency for the L0 backend.       |
...
### DNNL_EXPERIMENTAL_SELF_SUFFICIENT_L0
