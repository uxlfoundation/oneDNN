...
__kernel void ref_matmul(__global SRC_DATA_T *A, __global WEI_DATA_T *B,
        ...
        __global DST_SCALES_DATA_T *dst_scales, long dst_scale_stride_n,
        long dst_scale_stride_m, long dst_scale_group_m, long group_K, long K,
        long N, long M, long D0, long D1, long D2, long bia_stride_d3,
...
#if WITH_DST_SCALES
        float dst_scale = 1.f;
        dst_scale = DST_SCALES_TO_REF(dst_scales[dst_scale_stride_n * n
