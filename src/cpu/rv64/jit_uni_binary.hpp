...
//   - f32/f16 tensors (f16 needs zvfh); src0 and dst share one memory desc,
//     src1's dtype may differ
...
//     which fit the available aux budget) and binary ops (f32/f16/s32/s8/u8
//     rhs; scalar / per_element / per_oc / per_oc_spatial / per_w broadcast),
