...
struct rnn_brgemm_t<prop_kind::forward> : public rnn_brgemm_base_t {
    ...
    brgemm_desc_t desc_iter_p2_NK2_tail_b1_[num_vanilla_gru_iter_part2_kernels_];
    ...
    brgemm_ker_ptr_t kernel_iter_p2_N_tail_b1_[num_vanilla_gru_iter_part2_kernels_];
    brgemm_ker_ptr_t kernel_iter_p2_K2_tail_b1_[num_vanilla_gru_iter_part2_kernels_];
    brgemm_ker_ptr_t kernel_iter_p2_NK2_tail_b1_[num_vanilla_gru_iter_part2_kernels_];
};
