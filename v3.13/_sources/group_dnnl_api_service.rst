...
.. ref-code-block:: cpp
	...
	bool :ref:`dnnl::verbose_profiling_enabled<doxid-group__dnnl__api__service_1ga9d2e01f952b124acd6b8a1e5e9e978f4>`();
...
.. _doxid-group__dnnl__api__service_1ga9d2e01f952b124acd6b8a1e5e9e978f4:
...
Sets the maximal ISA the library can dispatch to on the CPU. See :ref:`dnnl_cpu_isa_t <doxid-group__dnnl__api__service_1ga303bab5d2e7b371bb44495864df21dd2>` and :ref:`dnnl::cpu_isa <doxid-group__dnnl__api__service_1gabad017feb1850634bf3babdb68234f83>` for the list of the values accepted by the C and C++ API functions respectively.
...
Gets the maximal ISA the library can dispatch to on the CPU. See :ref:`dnnl_cpu_isa_t <doxid-group__dnnl__api__service_1ga303bab5d2e7b371bb44495864df21dd2>` and :ref:`dnnl::cpu_isa <doxid-group__dnnl__api__service_1gabad017feb1850634bf3babdb68234f83>` for the list of the values returned by the C and C++ API functions respectively.
...
Sets the hints flag for the CPU ISA. See :ref:`dnnl_cpu_isa_hints_t <doxid-group__dnnl__api__service_1gaf356412d94e35579bd509ed1fa174f5d>` and :ref:`dnnl::cpu_isa_hints <doxid-group__dnnl__api__service_1gaf574021058ebc6965da14fc4387dd0c4>` for the list of the values accepted by the C and C++ API functions respectively.
...
Gets the ISA specific hints that library can follow. See :ref:`dnnl_cpu_isa_hints_t <doxid-group__dnnl__api__service_1gaf356412d94e35579bd509ed1fa174f5d>` and :ref:`dnnl::cpu_isa_hints <doxid-group__dnnl__api__service_1gaf574021058ebc6965da14fc4387dd0c4>` for the list of the values returned by the C and C++ API functions respectively.
...
.. index:: pair: function; dnnl_verbose_profiling_enabled
.. _doxid-group__dnnl__api__service_1ga50608f3f3888ebbb3d007a50a63e0e04:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_verbose_profiling_enabled(int* enabled)
...
.. list-table::
	...
	*
		...
		- Output flag set to 1 if any verbose profiling output is enabled and 0 otherwise.



.. rubric:: Returns:

:ref:`dnnl_invalid_arguments <doxid-group__dnnl__api__utils_1ggad24f9ded06e34d3ee71e7fc4b408d57aaecec97c787d74a33924abcf16ae4f51c>` / :ref:`dnnl::status::invalid_arguments <doxid-group__dnnl__api__service_1gga7acc4d3516304ae68a1289551d8f2cdda242ac674d98ee2191f0bbf6de851d2d0>` if the ``enabled`` pointer is NULL, and :ref:`dnnl_success <doxid-group__dnnl__api__utils_1ggad24f9ded06e34d3ee71e7fc4b408d57aaa31395e9dccc103cf166cf7b38fc5b9c>` / :ref:`dnnl::status::success <doxid-group__dnnl__api__service_1gga7acc4d3516304ae68a1289551d8f2cdda260ca9dd8a4577fc00b7bd5810298076>` on success.
