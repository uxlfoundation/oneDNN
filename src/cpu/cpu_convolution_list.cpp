...
const std::map<pk_dt_impl_key_t, std::vector<impl_list_item_t>> &impl_list_map() {
    static const std::map<pk_dt_impl_key_t, std::vector<impl_list_item_t>> the_map = REG_CONV_P({
        ...
        {{forward, f32, f32, f32}, {
            ...
            CPU_INSTANCE_AARCH64(jit_sve_convolution_fwd_t<f32,f32,f32,sve_128>) // This is lower than the equivalent sve_256/512 because it still needs some optimization
        ...
        {{backward_weights, f32, f32, f32}, REG_BWD_PK({
            ...
            CPU_INSTANCE_AARCH64(jit_sve_convolution_bwd_weights_t<f32,f32,f32,sve_128>)
