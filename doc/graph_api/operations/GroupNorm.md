...
|:---------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------|:----------------------------------------------|:---------------------|
| [groups](@ref dnnl::graph::op::attr::groups)                 | Specifies the number of groups `G` that the channel dimension will be divided into. the number of channels should be divisible by `groups`                                                              | s64        |  between 1 and the number of channels `C` in the input tensor                                 | Required             |
