...
//
// All arithmetic runs in the f32 e32/m4 compute domain; f16 operands are
// widened/narrowed at the load/store edge (vfwcvt/vfncvt, LMUL pair e16/m2).
...
struct jit_uni_binary_kernel_t : public binary_kernel_t {
    ...
    // v4 = src0/accumulator, v8 = src1, v12/v16 = f16 staging (also the sum
    ...
    // particular whether an f16 (zvfh) binary rhs is a legal post-op operand.
