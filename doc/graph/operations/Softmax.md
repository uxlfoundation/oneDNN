...
| [mode](@ref dnnl::graph::op::attr::mode) | Spcifies the computation mode of SoftMax                  | string     | `none` (default), `safe`             | Optional             |
...
dimension. To prevent from that, the user can set the attribute to `safe`, the
