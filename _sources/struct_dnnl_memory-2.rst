...
.. ref-code-block:: cpp
	...
	struct memory: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		template <typename T>
		:ref:`memory<doxid-structdnnl_1_1memory_1ad580c816d652ab2d7197c3fd39129599>`(const :ref:`desc<doxid-structdnnl_1_1memory_1_1desc>`& md, const T value);
		...
		template <typename T>
		T :ref:`get_host_scalar_value<doxid-structdnnl_1_1memory_1ae272d5c6ef49f606dc0fc8cbf04219b7>`() const;
	
		template <typename T>
		void :ref:`set_host_scalar_value<doxid-structdnnl_1_1memory_1a0a87c1ff961b1b56163f39ecdefae41e>`(const T value) const;
...
.. index:: pair: function; memory
.. _doxid-structdnnl_1_1memory_1ad580c816d652ab2d7197c3fd39129599:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	template <typename T>
	memory(const :ref:`desc<doxid-structdnnl_1_1memory_1_1desc>`& md, const T value)

Constructs a memory object that wraps a host-side scalar value.

.. note:: 

   The scalar value is copied into the newly allocated memory storage, so the user does not need to manage the lifetime of the original scalar data.
...
.. list-table::
	...
	*
		...
		- The scalar value to be wrapped by the memory object.

	*
		- error

		- if the memory object could not be created.
...
Helper function that validates that an ``std::vector`` of dimensions can be safely converted to the C API array :ref:`dnnl_dims_t <doxid-group__dnnl__api__data__types_1ga8331e1160e52a5d4babe96736464095a>`. Throws if validation fails.
...
.. index:: pair: function; get_host_scalar_value
.. _doxid-structdnnl_1_1memory_1ae272d5c6ef49f606dc0fc8cbf04219b7:
...
.. list-table::
	...
	*
		...
		- Type to cast the scalar value to.

.. index:: pair: function; set_host_scalar_value
.. _doxid-structdnnl_1_1memory_1a0a87c1ff961b1b56163f39ecdefae41e:
...
.. note:: 
   ...
   The scalar value is copied into the memory storage, so the user does not need to manage the lifetime of the original scalar data.
...
.. list-table::
	...
	*
		...
		- Pointer to the scalar value to set.
...
Unmaps a memory object and writes back any changes made to the previously mapped memory buffer. The memory buffer corresponds to the given index.
