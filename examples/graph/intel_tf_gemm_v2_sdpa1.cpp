...
int main() {
    ...
    std::vector<int64_t> reshape1_out_shape {1, 8, 31, 31, 2};
    ...
    std::vector<int64_t> tr1_out_shape {1, 8, 2, 31, 31};
    ...
    std::vector<int64_t> reshape2_out_shape {
            8, 31, 62}; // input shape {16,128,1,128}
    ...
    std::vector<int64_t> dot2_out_shape {8, 256, 62};
