...
bool data_types_ok(
    ...
    bool is_fp4 = utils::one_of(data_type::f4_e2m1, src, wei, dst, bia)
            || utils::one_of(data_type::f4_e2m1, src, wei, dst, bia);
    ...
    if (prb.is_bwd_w) {
        ...
        ok &= utils::one_of(src, data_type::f8_e5m2, data_type::f8_e4m3, data_type::f4_e3m0, data_type::f4_e2m1,
                data_type::bf16, data_type::f16, data_type::f32,
                data_type::f64);
        ok &= (dst == src);
        ok &= (utils::one_of(wei, src, default_acc_type)
                || (utils::one_of(src, data_type::f8_e4m3, data_type::f8_e5m2, data_type::f4_e2m1, data_type::f4_e2m1)
                        && utils::one_of(wei, data_type::f8_e4m3,
                                data_type::f8_e5m2, data_type::f4_e2m1, data_type::f4_e2m1, data_type::f32,
