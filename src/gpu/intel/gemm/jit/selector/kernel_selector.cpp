...
const kcatalog::Entry *select1(const kcatalog::Catalog &catalog, int npatterns, const MatchParams *patterns, const EvaluateParams &eparams, EvaluateAuxOutput &aux,  std::map<double, const kcatalog::Entry *> & entries, SelectionObserver * observer)
{
...
const kcatalog::Entry *select(const kcatalog::Catalog &catalog, const MatchParams &pattern, const EvaluateParams &eparams, EvaluateAuxOutput &aux, std::map<double, const kcatalog::Entry *>& entries, SelectionObserver *observer)
{
    return select(catalog, 1, &pattern, eparams, aux, entries, observer);
}

const kcatalog::Entry *select(const kcatalog::Catalog &catalog, int npatterns, const MatchParams *patterns, const EvaluateParams &eparams, EvaluateAuxOutput &aux, std::map<double,const kcatalog::Entry *> &entries, SelectionObserver *observer )
{
    ...
    do {
        ...
        while (true) {
            if (!first) {
                ...
                if (!result) result = tmp_result; //return result;
            }
            first = false;
