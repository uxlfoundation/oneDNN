...
status_t kai_wino_reorder_t::pd_t::init(const engine_t *engine,
    ...
    VDISPATCH_REORDER(src_d.dims()[0] == wd.oc && src_d.dims()[1] == wd.ic
            ...
            "inconsistent Winograd weights descriptor");
    VDISPATCH_REORDER(wd.alpha > wd.r,
            "invalid Winograd tile, must have wd.alpha < wd.r");
    ...
    VDISPATCH_REORDER(supported, "unsupported datatype");
