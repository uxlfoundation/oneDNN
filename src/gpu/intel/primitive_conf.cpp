...
const char *get_type_name(data_type_t dt) {
    switch (dt) {
        ...
        case data_type::s2: return "s2";
        case data_type::u2: return "u2";
...
void def_data_type(
    ...
    switch (dt) {
        ...
        case data_type::s2:
            kernel_ctx.add_option(
                    utils::format("-D%s_DATA_T=%s -D%s_DT_S2", str, name, str));
            break;
        case data_type::u2:
            kernel_ctx.add_option(
                    utils::format("-D%s_DATA_T=%s -D%s_DT_U2", str, name, str));
            break;
        case data_type::s32:
            kernel_ctx.add_option(
