...
int main() {
    ...
    std::vector<int64_t> dot1_in1_shape {2, 3, 8};
    std::vector<int64_t> dot1_in2_shape {2, 8, 6};
    std::vector<int64_t> dot1_out_shape {
            2, 3, 6}; // also multiply 2nd operand shape
    ...
    std::vector<int64_t> reshape1_out_shape {1, 2, 3, 3, 2};
    ...
    std::vector<int64_t> tr1_out_shape {1, 2, 2, 3, 3};
    ...
    add_op.add_output(lt_add_out); // output shape is {1, 8, 2, 31, 31}
    ...
    transpose_2_op.add_output(lt_tr2_out); //output shape is {16,128,1,128}

    std::vector<int64_t> reshape2_out_shape {
            2, 3, 6}; // input shape {16,128,1,128}
    ...
    std::vector<int64_t> dot2_in1_shape {2, 8, 3};
    std::vector<int64_t> dot2_out_shape {2, 8, 6};
