...
* **[experimental]** Extended matmul with optional execution-time hint [`DNNL_ARG_HINT_MAX_GROUP_SIZE`] to communicate the maximum size of the group across the variable dimension for the execution call.
...
# Usability
## Common
* Extended information about primitive execution available in VTune Profiler with the same level of details as reported by oneDNN [verbose mode]. This feature requires VTune Profiler 2025.7 or later. [MFDNN-13682]
