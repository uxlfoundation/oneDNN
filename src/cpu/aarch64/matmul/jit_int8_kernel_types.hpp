...
struct brg_int8_t {
    ...
    // rd_block mentions the loop unroll factor along K dimension and bd_block represents the blocking along M dimension
    const int rd_block = 4, bd_block = 8;
    // ld_block represents the no.of vector registers used to load along the N dimension
    int ld_block = 6;
    int na, nb;
