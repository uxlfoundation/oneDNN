...
#define CPU_INSTANCE_NO_THREADPOOL(...) DNNL_NO_THREADPOOL(CPU_INSTANCE(__VA_ARGS__))
#define CPU_INSTANCE_AVX512_NO_THREADPOOL(...) DNNL_NO_THREADPOOL(CPU_INSTANCE_AVX512(__VA_ARGS__))
