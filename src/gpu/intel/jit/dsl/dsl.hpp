...
struct transform_t {
    ...
    v2::layout_t get_layout(const pvar_tile_t &sizes, type_t type,
    ...
    pvar_tile_t get_2d_tile(type_t type) const {
    ...
    pvar_tile_t get_block_tile(type_t type) const {
...
struct global_tensor_t {
    ...
    expr_t offset(const pvar_coord_t<int64_t> &coord) const {
