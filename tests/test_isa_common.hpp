...
inline const std::set<cpu_isa> &cpu_isa_list() {
    static const std::set<cpu_isa> isa_list {cpu_isa::avx2, cpu_isa::avx2_vnni,
            cpu_isa::avx2_vnni_2, cpu_isa::avx512_core,
            cpu_isa::avx512_core_vnni, cpu_isa::avx512_core_bf16,
            cpu_isa::avx512_core_fp16, cpu_isa::avx512_core_amx,
            cpu_isa::avx512_core_amx_fp16, cpu_isa::avx10_2,
            cpu_isa::avx10_2_amx_2, cpu_isa::avx10_2_ace, cpu_isa::isa_default};
