...
template <cpu_isa_t isa, typename Vmm>
void jit_uni_postops_injector_t<isa, Vmm>::compute_vector_range(dim_t start_idx,
        dim_t end_idx,
...
template <cpu_isa_t isa, typename Vmm>
void jit_uni_postops_injector_t<isa, Vmm>::compute_vector(dim_t idx,
        const binary_injector::rhs_arg_dynamic_params_t &rhs_arg_params) {
