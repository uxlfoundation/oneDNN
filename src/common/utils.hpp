...
struct dnnl_stringstream_t : public std::stringstream {
    template <typename... Args>
    dnnl_stringstream_t(Args &&...args)
...
struct dnnl_istringstream_t : public std::istringstream {
    template <typename... Args>
    dnnl_istringstream_t(Args &&...args)
...
struct dnnl_ostringstream_t : public std::ostringstream {
    template <typename... Args>
    dnnl_ostringstream_t(Args &&...args)
