...
void binary_executable_t::execute(
...
std::optional<::sycl::event> binary_executable_t::execute_sycl(stream_t *stream,
...
cl_event binary_executable_t::execute_ocl(stream_t *stream,
        const std::unordered_map<int, memory> &args,
