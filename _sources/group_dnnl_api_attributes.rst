...
.. toctree::
	...
	enum_dnnl_quantization_mode_t.rst
...
.. ref-code-block:: cpp
	...
	enum :ref:`dnnl::quantization_mode<doxid-group__dnnl__api__attributes_1ga43df4b809a4544d34bbc106d3e409b2c>`;
	...
	:ref:`dnnl_quantization_mode_t<doxid-group__dnnl__api__attributes_1ga5342e1d6b2a09ea01660b3a3c2400826>` :ref:`dnnl::convert_to_c<doxid-group__dnnl__api__attributes_1ga6678e7dafb8afa412be59d2e9c615d0a>`(:ref:`quantization_mode<doxid-group__dnnl__api__attributes_1ga43df4b809a4544d34bbc106d3e409b2c>` qmode);
...
.. index:: pair: function; convert_to_c
.. _doxid-group__dnnl__api__attributes_1ga6678e7dafb8afa412be59d2e9c615d0a:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_quantization_mode_t<doxid-group__dnnl__api__attributes_1ga5342e1d6b2a09ea01660b3a3c2400826>` dnnl::convert_to_c(:ref:`quantization_mode<doxid-group__dnnl__api__attributes_1ga43df4b809a4544d34bbc106d3e409b2c>` qmode)
...
.. _doxid-group__dnnl__api__attributes_1gaa99e375cd5745218290260ff7b9e56e2:
...
.. list-table::
	...
	*
		...
		- Output memory descriptor for dropout masks. If a default memory descriptor is returned, the mask values will not be written to the output memory buffer during the primitive execution.
...
.. _doxid-group__dnnl__api__attributes_1ga29956085de89106951a10f290e4aab87:
...
.. list-table::
	...
	*
		...
		- Memory descriptor for dropout masks. If a default memory descriptor is passed, the mask values will not be written to the output memory buffer during the primitive execution.
...
.. index:: pair: function; dnnl_primitive_attr_get_dropout_v2
.. _doxid-group__dnnl__api__attributes_1gab454f97e8357612891a66cf99a9a51a1:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_get_dropout_v2(
		:ref:`const_dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga871d7ee732a90fec43f1c878581bb59a>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>`* mask_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>`* seed_dt,
		int* use_offset,
...
.. list-table::
	...
	*
		...
		- Output datatype for seed argument.

	*
		- use_offset

		- Output boolean. If true, an offset argument must be passed at the execution and will be used in random number generation.

	*
		- use_host_scalars

		- Output boolean. If true, probability, seed and offset arguments are passed as host_scalar memory objects.
...
.. index:: pair: function; dnnl_primitive_attr_set_dropout_v2
.. _doxid-group__dnnl__api__attributes_1ga7cb40c98418d2d1098759a29ba018e73:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_set_dropout_v2(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>` mask_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` seed_dt,
		int use_offset,
...
.. list-table::
	...
	*
		...
		- Datatype for seed argument.

	*
		- use_offset

		- If true, an offset argument must be passed at the execution and will be used in random number generation.

	*
		- use_host_scalars

		- If true, probability, seed and offset arguments are passed as host_scalar memory objects.
...
Sets primitive attributes scaling factors for primitive operations for a given memory argument. The scaling factors must be passed at execution time as an argument with index :ref:`DNNL_ARG_ATTR_SCALES <doxid-group__dnnl__api__primitives__common_1ga7f52f0ef5ceb99e163f3ba7f83c18aed>` \| arg.
...
.. _doxid-group__dnnl__api__attributes_1ga106d72578021ab7ac79c227ee3a886e7:
...
:ref:`dnnl_primitive_attr_set_scales <doxid-group__dnnl__api__attributes_1ga106d72578021ab7ac79c227ee3a886e7>`

.. index:: pair: function; dnnl_primitive_attr_set_scales_v2
.. _doxid-group__dnnl__api__attributes_1gafc415a17846b560f017b48a0991ddd65:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_set_scales_v2(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
...
Sets primitive attributes scaling factors for primitive operations for a given memory argument. The scaling factors must be passed at execution time as an argument with index :ref:`DNNL_ARG_ATTR_SCALES <doxid-group__dnnl__api__primitives__common_1ga7f52f0ef5ceb99e163f3ba7f83c18aed>` \| arg. If ``is_on_host`` is true, sets a single host-side scalar scaling factor for the specified memory argument. In this case, the scaling factor must be provided as a host scalar memory object at execution time with index :ref:`DNNL_ARG_ATTR_SCALES <doxid-group__dnnl__api__primitives__common_1ga7f52f0ef5ceb99e163f3ba7f83c18aed>` \| arg.
...
.. index:: pair: function; dnnl_primitive_attr_set_scales_v3
.. _doxid-group__dnnl__api__attributes_1ga535630984f8fdbeda4b80a745e093091:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_set_scales_v3(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
...
.. list-table::
	...
	*
		...
		- Indicates whether the scale is a host-side scalar.

	*
		- qmode

		- Quantization mode, can be :ref:`dnnl_quantization_mode_static_sazp <doxid-group__dnnl__api__attributes_1gga5342e1d6b2a09ea01660b3a3c2400826a69f0c0079f39bec2332481404e199315>` or :ref:`dnnl_quantization_mode_dynamic_mx <doxid-group__dnnl__api__attributes_1gga5342e1d6b2a09ea01660b3a3c2400826a9d29b3c3bf3c43cab388533e093cd8a6>`
...
Sets primitive attributes zero points for primitive operations for a given memory argument. The zero points must be passed at execution time as an argument with index :ref:`DNNL_ARG_ATTR_ZERO_POINTS <doxid-group__dnnl__api__primitives__common_1gaf8d879adfe2baa2f9f2a5143a0f274b6>` \| arg.
...
.. _doxid-group__dnnl__api__attributes_1ga035d40992980f8726b2d18b3e51fb296:
...
.. list-table::
	...
	*
		...
		- Zero point correspondence mask that defines the correspondence between the tensor dimensions and the zero points array. The set i-th bit indicates that a dedicated zero point is used for each index along that dimension. Set the mask to 0 to use a common zero point for the whole output tensor.
	...
	*
		...
		- Zero point factors correspondence groups that define the correspondence between the tensor dimensions and the zero points array. The group dimensions should be only provided for each logical dimension that has the bit set correspondence mask ``mask`` set.
...
.. index:: pair: function; dnnl_primitive_attr_set_precomputed_reductions
.. _doxid-group__dnnl__api__attributes_1ga8a3a3116cdd4e0708416cbfd338e0637:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_set_precomputed_reductions(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int group_ndims,
...
Sets primitive attributes precomputed reductions for primitive operations for a given memory argument. The precomputed reductions must be passed at execution time as an argument with index :ref:`DNNL_ARG_ATTR_PRECOMPUTED_REDUCTIONS <doxid-group__dnnl__api__primitives__common_1gaf93206705986fac3699312b12110e608>` \| arg.
...
.. list-table::
	...
	*
		...
		- Precomputed reductions correspondence mask that defines the correspondence between the tensor dimensions and the precomputed reductions array. The set i-th bit indicates that a dedicated precomputed reductions is used for each index along that dimension.
	...
	*
		...
		- Precomputed reduction factors correspondence groups that define the correspondence between the tensor dimensions and the precomputed reductions array. The group dimensions should be only provided for each logical dimension that has the bit set correspondence mask ``mask`` set.
...
.. index:: pair: function; dnnl_primitive_attr_set_zero_points_v2
.. _doxid-group__dnnl__api__attributes_1ga36b22235abbb4e24b4284fa7ade0167f:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_primitive_attr_set_zero_points_v2(
		:ref:`dnnl_primitive_attr_t<doxid-group__dnnl__api__attributes_1ga06d701a25b82d4c8a93aaabb93e03dc3>` attr,
		int arg,
		int mask,
		int ndims,
...
Sets primitive attributes zero points for primitive operations for a given memory argument. The zero points must be passed at execution time as an argument with index :ref:`DNNL_ARG_ATTR_ZERO_POINTS <doxid-group__dnnl__api__primitives__common_1gaf8d879adfe2baa2f9f2a5143a0f274b6>` \| arg. If ``is_on_host`` is true, sets a single host-side scalar zero point for the specified memory argument. In this case, the zero point must be provided as a host scalar memory object at execution time with index :ref:`DNNL_ARG_ATTR_ZERO_POINTS <doxid-group__dnnl__api__primitives__common_1gaf8d879adfe2baa2f9f2a5143a0f274b6>` \| arg.
