...
private:
    ...
    void copy_block(const int nrows, const int ncolumns, bool zeropad) {
        ...
        alignas(64) static constexpr uint8_t fp8_tail_mask_keep1[64]
                = {0xFF, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0x00,
                        ...
                        0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00,
                        0x00, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00};
        alignas(64) static constexpr uint8_t fp8_tail_mask_keep2[64]
                = {0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF,
                        ...
                        0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00,
                        0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00};
        alignas(64) static constexpr uint8_t fp8_tail_mask_keep3[64]
        ...
        for (int n = 0; n < direct_ncolumns; n += n_blk_step) {
            ...
            if (zeropad) {
                ...
                if (need_tail_mask) {
                    const uint8_t *tail_mask = rows_left == 1
                            ? fp8_tail_mask_keep1
