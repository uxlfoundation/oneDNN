...
// `prb_t` internally.
using init_memory_args_native_func_t
        = std::function<void(dnn_mem_map_t &mem_map, const base_prb_t *base_prb,
                const deserialized_op_t &base_op_ref, const engine_t &ref_eng)>;
