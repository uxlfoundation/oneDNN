...
.. ref-code-block:: cpp
	...
	struct primitive_desc_base: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		:ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` :ref:`query_s64<doxid-structdnnl_1_1primitive__desc__base_1acbedc4257eaa26f868356f9f594a856a>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const;
		...
		:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` :ref:`get_algorithm<doxid-structdnnl_1_1primitive__desc__base_1ae220e7adee4466f48e9a4781f0754461>`() const;
		...
		:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` :ref:`get_cell_kind<doxid-structdnnl_1_1primitive__desc__base_1a940546a82d1381597863ecc7036b9c22>`() const;
		:ref:`dnnl::rnn_direction<doxid-group__dnnl__api__cpp__rnn_1ga33315cf335d1cbe26fd6b70d956e23d5>` :ref:`get_direction<doxid-structdnnl_1_1primitive__desc__base_1a7b9b95f2e16e3d2a9644df7ad5436f63>`() const;
		:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` :ref:`get_activation_kind<doxid-structdnnl_1_1primitive__desc__base_1acc309d5adeb8dbe8a88a18105082d566>`() const;
		...
		:ref:`dnnl::prop_kind<doxid-group__dnnl__api__cpp__attributes_1gac7db48f6583aa9903e54c2a39d65438f>` :ref:`get_prop_kind<doxid-structdnnl_1_1primitive__desc__base_1a9adba18a967c92b205e939ba34de3542>`() const;
		:ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>` :ref:`query_md<doxid-structdnnl_1_1primitive__desc__base_1a35d24b553ba6aa807516e9470fdd7d16>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what, int idx = 0) const;
	...
	protected:
		...
		:ref:`primitive_desc_base<doxid-structdnnl_1_1primitive__desc__base_1af4eac2eea0fd4eb37c0c90ead14ad52b>`(
			...
			:ref:`dnnl::prop_kind<doxid-group__dnnl__api__cpp__attributes_1gac7db48f6583aa9903e54c2a39d65438f>` aprop_kind
			);
	
		:ref:`primitive_desc_base<doxid-structdnnl_1_1primitive__desc__base_1aa4853f3190cac45b653e510b6eeed97a>`(
			:ref:`dnnl_primitive_desc_t<doxid-group__dnnl__api__primitives__common_1gaabde3e27edf071b62b39f47bace7efd6>` pd,
			:ref:`dnnl::primitive::kind<doxid-structdnnl_1_1primitive_1ad1ec93215a0cf3aa0a32bae0c2cd9169>` prim_kind,
			:ref:`dnnl::prop_kind<doxid-group__dnnl__api__cpp__attributes_1gac7db48f6583aa9903e54c2a39d65438f>` prop_kind1,
			:ref:`dnnl::prop_kind<doxid-group__dnnl__api__cpp__attributes_1gac7db48f6583aa9903e54c2a39d65438f>` prop_kind2
			);

		// methods
	
		float :ref:`query_f32<doxid-structdnnl_1_1primitive__desc__base_1aac2d65e11e31277bdcd8c45c535f4904>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const;
		:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` :ref:`query_alg<doxid-structdnnl_1_1primitive__desc__base_1a8900dd626600d817448cd817842386fe>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const;
		:ref:`memory::dims<doxid-structdnnl_1_1memory_1a7d9f4b6ad8caf3969f436cd9ff27e9bb>` :ref:`query_dims<doxid-structdnnl_1_1primitive__desc__base_1a80fccdba1716378a8bf76db2134e3d8b>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const;
		:ref:`engine<doxid-structdnnl_1_1engine>` :ref:`query_engine<doxid-structdnnl_1_1primitive__desc__base_1a6aa3cf6000aabcf202fda2197a0b8e70>`(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const;
...
.. ref-code-block:: cpp
	...
	:ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` query_s64(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive does not have a strides parameter.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive does not have a dilations parameter.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive does not have a left padding parameter.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive does not have a right padding parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` get_algorithm() const
...
:ref:`dnnl::algorithm::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive does not have an algorithm parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` get_cell_kind() const
...
:ref:`dnnl::algorithm::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive does not have an RNN cell kind parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`dnnl::rnn_direction<doxid-group__dnnl__api__cpp__rnn_1ga33315cf335d1cbe26fd6b70d956e23d5>` get_direction() const
...
:ref:`dnnl::rnn_direction::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive does not have an RNN direction parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`dnnl::algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` get_activation_kind() const
...
:ref:`dnnl::algorithm::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive does not have an RNN activation kind parameter.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive does not have a pooling kernel parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`dnnl::prop_kind<doxid-group__dnnl__api__cpp__attributes_1gac7db48f6583aa9903e54c2a39d65438f>` get_prop_kind() const
...
:ref:`dnnl::prop_kind::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive does not have a propagation parameter.
...
.. ref-code-block:: cpp
	...
	:ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>` query_md(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what, int idx = 0) const
...
.. list-table::
	...
	*
		...
		- The kind of parameter to query; can be :ref:`dnnl::query::src_md <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a90a729e395453e1d9411ad416c796819>`, :ref:`dnnl::query::dst_md <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a701158248eed4e5fc84610f2f6026493>`, etc.

	*
		- idx

		- Index of the parameter. For example, convolution bias can be queried with what = :ref:`dnnl::query::weights_md <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a06ba7b00a8c95dcf3a90e16d00eeb0e9>` and idx = 1.
...
:ref:`Scratchpad <doxid-dev_guide_attributes_scratchpad>`
...
.. ref-code-block:: cpp
	...
	float query_f32(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const
...
.. ref-code-block:: cpp
	...
	:ref:`algorithm<doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` query_alg(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const

Returns an :ref:`dnnl::algorithm <doxid-group__dnnl__api__cpp__attributes_1ga00377dd4982333e42e8ae1d09a309640>` value.
...
:ref:`dnnl::algorithm::undef <doxid-group__dnnl__api__cpp__attributes_1gga43df4b809a4544d34bbc106d3e409b2caf31ee5e3824f1f5e5d206bdf3029f22b>` if the primitive doesn't support the query.
...
.. ref-code-block:: cpp
	...
	:ref:`memory::dims<doxid-structdnnl_1_1memory_1a7d9f4b6ad8caf3969f436cd9ff27e9bb>` query_dims(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the primitive doesn't support the query.
...
.. ref-code-block:: cpp
	...
	:ref:`engine<doxid-structdnnl_1_1engine>` query_engine(:ref:`query<doxid-group__dnnl__api__cpp__primitives__common_1ga94efdd650364f4d9776cfb9b711cbdc1>` what) const
