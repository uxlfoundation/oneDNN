.. index:: pair: example; mxfp_matmul.cpp
.. _doxid-mxfp_matmul_8cpp-example:

mxfp_matmul.cpp
===============

Annotated version: :ref:`MatMul Tutorial: MXFP8 Inference <doxid-mxfp_matmul_cpp>`
...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	void prepare_input(:ref:`memory <doxid-structdnnl_1_1memory>` &in_mem) {
	    auto dims = in_mem.:ref:`get_desc <doxid-structdnnl_1_1memory_1ad8a1ad28ed7acf9c34c69e4b882c6e92>`().:ref:`get_dims <doxid-structdnnl_1_1memory_1_1desc_1a525c3c9e3946275b3f386c2f79e8b830>`();
	...
	void quantize_input(:ref:`memory <doxid-structdnnl_1_1memory>` &in_e4m3, :ref:`memory <doxid-structdnnl_1_1memory>` &in_scales_e8m0, :ref:`memory <doxid-structdnnl_1_1memory>` &in_f32) {
	    // This is the conversion routine defined by OCP MX spec v1
	    const auto dims = in_f32.:ref:`get_desc <doxid-structdnnl_1_1memory_1ad8a1ad28ed7acf9c34c69e4b882c6e92>`().:ref:`get_dims <doxid-structdnnl_1_1memory_1_1desc_1a525c3c9e3946275b3f386c2f79e8b830>`();
	    const auto nelems = product(dims);
	    float *ptr = static_cast<float *>(in_f32.:ref:`get_data_handle <doxid-structdnnl_1_1memory_1a24aaca8359e9de0f517c7d3c699a2209>`());
	    uint8_t *ptr_scales
	            = static_cast<uint8_t *>(in_scales_e8m0.:ref:`get_data_handle <doxid-structdnnl_1_1memory_1a24aaca8359e9de0f517c7d3c699a2209>`());
	...
	void mxfp_matmul(:ref:`engine::kind <doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind) {
	    ...
	    {
	        :ref:`memory <doxid-structdnnl_1_1memory>` A_f32({a_desc.get_dims(), :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`,
	                             a_desc.get_strides()},
	                eng);
	        prepare_input(A_f32);
	    ...
	    {
	        :ref:`memory <doxid-structdnnl_1_1memory>` B_f32({b_desc.get_dims(), :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`,
	                             b_desc.get_strides()},
	                eng);
	        prepare_input(B_f32);
