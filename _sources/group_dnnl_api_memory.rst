...
.. index:: pair: function; dnnl_memory_desc_create_with_grouped_encoding
.. _doxid-group__dnnl__api__memory_1ga131454ec794a5eef89686ab0344a7111:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_memory_desc_create_with_grouped_encoding(
		:ref:`dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1gad281fd59c474d46a60f9b3a165e9374f>`* memory_desc,
		int ndims,
		const :ref:`dnnl_dims_t<doxid-group__dnnl__api__data__types_1ga8331e1160e52a5d4babe96736464095a>` dims,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` data_type,
...
Creates a memory descriptor for grouped memory encoding, that stores multiple independent sub-tensors.

Common use case is Mixture-of-Experts (MoE) workloads where each expert processes different numbers of tokens.
...
Example in the context of MoE: Below is how to describe 3 experts with token counts [1, 3, 5] and feature dim 256
...
.. list-table::
	...
	*
		...
		- Array of dimensions representing the overall tensor shape.
	...
	*
		...
		- Index of the dimension with variable size per sub-tensor.

	*
		- group_count

		- Number of sub-tensors included.

	*
		- offsets_dt

		- Data type of the offsets array.
...
.. index:: pair: function; dnnl_memory_desc_create_host_scalar
.. _doxid-group__dnnl__api__memory_1gae52f3003429b2a60bd15b710977fe361:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_memory_desc_create_host_scalar(
		:ref:`dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1gad281fd59c474d46a60f9b3a165e9374f>`* memory_desc,
		:ref:`dnnl_data_type_t<doxid-group__dnnl__api__data__types_1ga012ba1c84ff24bdd068f9d2f9b26a130>` data_type
		)
...
Queries a memory descriptor for various pieces of information. This version support additional queries :ref:`dnnl_query_sparse_encoding <doxid-group__dnnl__api__primitives__common_1gga9e5235563cf7cfc10fa89f415de98059a21815bb69d71340b0556f123ba6fdd69>`, :ref:`dnnl_query_nnz_s64 <doxid-group__dnnl__api__primitives__common_1gga9e5235563cf7cfc10fa89f415de98059a5ca45f20f5864e069149106f21f5ff92>` :ref:`dnnl_query_num_handles_s32 <doxid-group__dnnl__api__primitives__common_1gga9e5235563cf7cfc10fa89f415de98059a7d92c3824fd1811f6bc641e2fdfbc2bb>` and :ref:`dnnl_query_data_type <doxid-group__dnnl__api__primitives__common_1gga9e5235563cf7cfc10fa89f415de98059aab9ebb3344a6e3b283801c8266b56530>` for a particular buffer.
...
.. index:: pair: function; dnnl_memory_create_host_scalar
.. _doxid-group__dnnl__api__memory_1gabe53ba0e17bcb92509c3bbbd250e520b:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_memory_create_host_scalar(
		:ref:`dnnl_memory_t<doxid-group__dnnl__api__memory_1ga2b79954bd7bb293e766a89189e8440fd>`* memory,
		:ref:`const_dnnl_memory_desc_t<doxid-group__dnnl__api__memory_1ga402f0cb4399cd56445803cfa433aac6d>` memory_desc,
		void* scalar_ptr
		)
...
.. note:: 
   ...
   The scalar value is copied from the provided pointer into the newly allocated memory storage, so the user does not need to manage the lifetime of the original scalar data.
...
.. list-table::
	...
	*
		...
		- Output host-side scalar memory object.

	*
		- memory_desc

		- Memory descriptor describing a scalar value residing on the host.

	*
		- scalar_ptr

		- Pointer to the scalar value to be copied into the memory object. This should be a host pointer to the scalar data.



.. rubric:: Returns:

:ref:`dnnl_success <doxid-group__dnnl__api__utils_1ggad24f9ded06e34d3ee71e7fc4b408d57aaa31395e9dccc103cf166cf7b38fc5b9c>` on success; otherwise, returns a status code describing the error.
...
Maps a memory object and returns a host-side pointer to a memory buffer with a copy of its contents. The memory buffer corresponds to the given index.
...
Unmaps a memory object and writes back any changes made to the previously mapped memory buffer. The pointer to the mapped buffer must be obtained via the :ref:`dnnl_memory_map_data() <doxid-group__dnnl__api__memory_1gac9006cdf6816b8bef7be3455ab0ceb49>` call.
...
Unmaps a memory object and writes back any changes made to the previously mapped memory buffer. The pointer to the mapped buffer must be obtained via the :ref:`dnnl_memory_map_data() <doxid-group__dnnl__api__memory_1gac9006cdf6816b8bef7be3455ab0ceb49>` call. The buffer corresponds to the given index.
...
.. index:: pair: function; dnnl_memory_get_host_scalar_value
.. _doxid-group__dnnl__api__memory_1ga1c9c615901b76e4493d7c9c8f299e7ed:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_memory_get_host_scalar_value(
		:ref:`const_dnnl_memory_t<doxid-group__dnnl__api__memory_1ga0f89ee8e9b55b302b3f5277d11302f7e>` memory,
		void* value
		)
...
.. list-table::
	...
	*
		...
		- Host-side scalar memory object.

	*
		- value

		- Output pointer to the scalar value. The type of the value depends on the data type of the memory object.
...
.. index:: pair: function; dnnl_memory_set_host_scalar_value
.. _doxid-group__dnnl__api__memory_1ga6be28e263bcee8d85684ed218902f995:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`dnnl_status_t<doxid-group__dnnl__api__utils_1gad24f9ded06e34d3ee71e7fc4b408d57a>` DNNL_API dnnl_memory_set_host_scalar_value(
		:ref:`dnnl_memory_t<doxid-group__dnnl__api__memory_1ga2b79954bd7bb293e766a89189e8440fd>` memory,
		const void* value
		)
...
.. note:: 
   ...
   The value would be copied from the provided pointer into the memory object, so the user does not need to manage the lifetime of the original scalar data.
...
.. list-table::
	...
	*
		...
		- Pointer to the scalar value to be copied into the memory object. The type of the value must match the data type of the memory object.
...
A ``size_t`` counterpart of the DNNL_RUNTIME_DIM_VAL. For instance, this value is returned by :ref:`dnnl_memory_desc_get_size() <doxid-group__dnnl__api__memory_1gae7569a047fdd954866df70f01b63e647>` if either of the dimensions or strides equal to :ref:`DNNL_RUNTIME_DIM_VAL <doxid-group__dnnl__api__memory_1gaa596c5a6102df77a550bad98f0d5cc12>`.
