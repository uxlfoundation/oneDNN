...
public:
    ...
    status_t execute(stream_t *stream, const std::vector<tensor_t> &inputs,
    ...
    status_t execute_sycl(stream_t *stream, const std::vector<tensor_t> &inputs,
            const std::vector<tensor_t> &outputs,
    ...
    // future.
    status_t execute_ocl(stream_t *stream, const std::vector<tensor_t> &inputs,
            const std::vector<tensor_t> &outputs,
            const tensor_t *scratchpad_buf,
