...
//    testing::Values(
//                    sdpa_dims_t{   1,       2,        2,     32,      32,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,     33,       1,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    128,      64,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    129,       1,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    259,       1,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    384,     384,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    384,     384,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_tensor,             no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    384,     384,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_tensor1,            no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    384,     384,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_tensor3,            no_key_transposed, mask_type::twoD },
//                    sdpa_dims_t{   1,       2,        2,    384,     384,       96,   96,      96, mdt::f16,  mdt::f16, mdt::s8,  mdt::f16, mdt::s8, mdt::s8, mdt::f16, mdt::s8, mdt::f16, quantize_type::per_token,              no_key_transposed, mask_type::twoD }
//    ), &print_to_string);
...
INSTANTIATE_TEST_SUITE_P(head_size_512,
    sdpa_test_t,
                               // mb,  hd_num, kv_grp_sz,seq_len, qry_num, hd_size, kg_sz, vgrp_sz,       dt,       qdt,       kdt,        ksdt,      kzpdt,        vdt,       vsdt,      vzpdt,     mskdt, qtype
    testing::Values(
//  first token
                    sdpa_dims_t{   1,      32,        32,    32,     32,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    64,     64,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    128,     128,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    256,     256,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    384,     384,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    512,     512,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    1024,     1024,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    2048,     2048,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    4096,     4096,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    //sdpa_dims_t{   1,      8,        8,    32768,     32,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },

// thin q, second token
                    sdpa_dims_t{   1,      32,        32,    33,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    65,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    129,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    257,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    385,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    513,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    1025,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    2049,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    4097,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    //sdpa_dims_t{   1,      8,        8,    32769,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::f16,    mdt::f16,    mdt::s8,    mdt::f16,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal }

//  first token, quantized
                    sdpa_dims_t{   1,      32,        32,    32,     32,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    64,     64,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    128,     128,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    256,     256,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    384,     384,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    512,     512,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    1024,     1024,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    2048,     2048,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    4096,     4096,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },

// thin q, second token, quantized
                    sdpa_dims_t{   1,      32,        32,    33,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    65,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    129,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    257,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    385,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    513,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    1025,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    2049,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,      32,        32,    4097,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },

                    sdpa_dims_t{   1,       2,         2,    33,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    65,      1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    129,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    257,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    385,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    513,     1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    1025,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    2049,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal },
                    sdpa_dims_t{   1,       2,         2,    4097,    1,     512,     512,     512, mdt::f16,  mdt::f16,   mdt::s8,    mdt::f16,    mdt::s8,    mdt::s8,   mdt::f16,    mdt::s8, mdt::f16, quantize_type::per_token_with_groups,  with_key_transposed,  mask_type::causal }
    ), &print_to_string);
