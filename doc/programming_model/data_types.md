...
| ISA                                                  | f64    | f32    | bf16   | f16    | s8/u8  | f8     | f4     | s4/u4  |
| ---------------------------------------------------- | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| Intel SSE4.1                                         |        | `+`    |        |        |        |        |        |        |
| Intel AVX                                            |        | `+`    |        |        |        |        |        |        |
| Intel AVX2                                           |        | `+`    |        |        | `+`    |        |        |        |
| Intel AVX2 with Intel DL Boost (int8)                |        | `+`    |        |        | `+`(1) |        |        |        |
| Intel AVX2 with Intel DL Boost (int8, bf16)          |        | `+`    | `+`    |        | `+`    |        |        |        |
| Intel AVX2 with Intel DL Boost (int8, bf16, fp16)    |        | `+`    | `+`    | `.`    | `+`    |        |        |        |
| Intel AVX-512                                        |        | `+`    | `.`(2) |        | `+`(1) |        |        |        |
...
| Intel AVX10.1/512 with Intel AMX (int8, bf16, fp16)  |        | `+`    | `+`    | `+`    | `+`    | `.`    |        | `.`    |
| Intel AVX10.2                                        |        | `+`    | `+`    | `+`    | `+`    | `.`    | `.`    | `.`    |
| Intel AVX10.2 with Intel AMX (int8, bf16, fp16, fp8) |        | `+`    | `+`    | `+`    | `+`    | `+`    | `.`    | `.`    |

Legend:
* `+` indicates full support with compute acceleration.
* `.` indicates functional support through conversions to higher precision data
  type or support as a storage format for weights.
...
Footnotes:
1. Xe-LP and Xe-HPG architectures do not support f16 operations with f32
