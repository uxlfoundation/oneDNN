...
oneDNN supports ITT tagging at primitive execution in order to provide performance information at the level of a oneDNN primitive. This feature is supported on both CPU and GPU.

ITT tagging in oneDNN during primitive execution provides more information from VTune Profiler for the following items:
...
#. Map primitives with related computation kernels.
...
When the feature is enabled at build-time, the ``ONEDNN_ITT_TASK_LEVEL`` environment variable can be used to specify the level of ITT tagging.
...
See more examples in the `VTune Profiler User Guide <https://www.intel.com/content/www/us/en/docs/vtune-profiler/user-guide/2025-4/overview.html>`__
