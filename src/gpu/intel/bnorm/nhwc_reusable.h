...
*******************************************************************************/
#ifndef GPU_INTEL_BNORM_NHWC_REUSABLE_H
#define GPU_INTEL_BNORM_NHWC_REUSABLE_H

#define MAX_IC_BLOCK_SGROUPS (MAX_IC_BLOCK / SUB_GROUP_SIZE)
#define MAX_IC_VECT_SGROUPS (MAX_IC_BLOCK_SGROUPS / VECT_SIZE)
#define MAX_IC_TAIL_SGROUPS (VECT_SIZE - 1)
#define MAY_HAVE_IC_TAIL (MAX_IC_TAIL_SGROUPS > 0)

#if VECT_SIZE > 1
#define VFLOAT(v, i) (v)[i]
#else
#define VFLOAT(v, i) (v)
#endif
...
#endif // GPU_INTEL_BNORM_NHWC_REUSABLE_H
