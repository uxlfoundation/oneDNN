...
.. ref-code-block:: cpp
	...
	struct desc: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		static desc :ref:`grouped<doxid-structdnnl_1_1memory_1_1desc_1a56f86b15ab0ad07356207766c72661d0>`(
			const :ref:`dims<doxid-structdnnl_1_1memory_1a7d9f4b6ad8caf3969f436cd9ff27e9bb>`& adims,
			:ref:`data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` adata_type,
			int variable_dim_idx,
			:ref:`dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` group_count,
			:ref:`data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` offsets_dt = :ref:`data_type::s32<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dceaa860868d23f3a68323a2e3f6563d7f31>`,
			bool allow_empty = false
			);
	
		static desc :ref:`host_scalar<doxid-structdnnl_1_1memory_1_1desc_1a27db39fcff710e27f134e107a1ec8857>`(:ref:`data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` adata_type);
	};
...
Construct a memory descriptor from a C API :ref:`dnnl_memory_desc_t <doxid-group__dnnl__api__memory_1gad281fd59c474d46a60f9b3a165e9374f>` handle. The resulting handle is not weak and the C handle will be destroyed during the destruction of the C++ object.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the memory descriptor does not have strides.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the memory descriptor does not have inner blocks.
...
An empty :ref:`dnnl::memory::dims <doxid-group__dnnl__api__cpp__primitives__common_1gga94efdd650364f4d9776cfb9b711cbdc1a5927205243f12cdc70612cba6dc874fa>` if the memory descriptor does not have inner indices.
...
.. index:: pair: function; grouped
.. _doxid-structdnnl_1_1memory_1_1desc_1a56f86b15ab0ad07356207766c72661d0:
...
Creates a memory descriptor for grouped encoding, that stores multiple independent sub-buffers (groups) with one dimension varying in size.
...
.. list-table::
	...
	*
		...
		- Tensor dimensions. For the variable dimension, specify the total size (sum across all groups).
	...
	*
		...
		- Index of dimension that varies between groups.

	*
		- group_count

		- Number of groups (e.g., number of experts in MoE).

	*
		- offsets_dt

		- Data type of offsets buffer. Default: s32.

	*
		- allow_empty

		- Allow construction to fail without exception. Returns zero descriptor on failure. Default: false.



.. rubric:: Returns:

Memory descriptor for grouped encoding.

.. index:: pair: function; host_scalar
.. _doxid-structdnnl_1_1memory_1_1desc_1a27db39fcff710e27f134e107a1ec8857:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	static desc host_scalar(:ref:`data_type<doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dce>` adata_type)
...
A memory descriptor for host-side scalar input.
