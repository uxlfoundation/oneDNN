...
status_t init_conf_bwd_w(jit_brgemm_conv_conf_t &jcp,
    ...
    //    const auto is_hf8 = is_fp8 && everyone_is(
    //            f8_e4m3, src_d.data_type(), diff_dst_d.data_type());

    jcp.isa = is_fp8
            ? (mayiuse(avx10_2_512_amx_2)
                            ? avx10_2_512_amx_2
                            //                     : mayiuse(avx10_2_512) && is_hf8 ? avx10_2_512
