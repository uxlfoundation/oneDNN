...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	void compute_attention(float *context_vectors, dim_t src_seq_length_max,
	        dim_t batch, dim_t feature_size, float *annotations,
	        float *weighted_annotations, const :ref:`memory <doxid-structdnnl_1_1memory>` &src_f32_mem,
	        const :ref:`memory <doxid-structdnnl_1_1memory>` &wei_f32_mem, const :ref:`memory <doxid-structdnnl_1_1memory>` &dst_f32_mem,
	        const :ref:`matmul <doxid-structdnnl_1_1matmul>` &matmul_f32_prim, const :ref:`memory <doxid-structdnnl_1_1memory>` &src_gemv_mem,
	    ...
	    matmul_f32_prim.:ref:`execute <doxid-structdnnl_1_1primitive_1a2c112f2449a18a87310dee2ecd8c64eb>`(strm,
	            {{:ref:`DNNL_ARG_SRC <doxid-group__dnnl__api__primitives__common_1gac37ad67b48edeb9e742af0e50b70fe09>`, src_f32_mem}, {:ref:`DNNL_ARG_WEIGHTS <doxid-group__dnnl__api__primitives__common_1gaf279f28c59a807e71a70c719db56c5b3>`, wei_f32_mem},
	                    {:ref:`DNNL_ARG_DST <doxid-group__dnnl__api__primitives__common_1ga3ca217e4a06d42a0ede3c018383c388f>`, dst_f32_mem}});
	...
	void simple_net() {
	    ...
	    auto enc_bidir_prim_desc = :ref:`lstm_forward::primitive_desc <doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`(cpu_engine,
	            :ref:`prop_kind::forward_inference <doxid-group__dnnl__api__cpp__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa3b9fad4f80d45368f856b5403198ac4c>`, :ref:`rnn_direction::bidirectional_concat <doxid-group__dnnl__api__cpp__rnn_1gga33315cf335d1cbe26fd6b70d956e23d5a7a1bb9f8699e8c03cbe4bd681fb50830>`,
	    ...
	    auto att_src_f32_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({batch, feature_size},
	    ...
	    auto att_wei_f32_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({feature_size, feature_size},
	            :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto att_dst_f32_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({batch, feature_size},
	            :ref:`memory::data_type::f32 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea512dc597be7ae761876315165dc8bd2e>`, :ref:`memory::format_tag::ab <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3fa187ef4436122d1cc2f40dc2b92f0eba0>`);
	    auto matmul_f32_pd = :ref:`matmul::primitive_desc <doxid-structdnnl_1_1matmul_1_1primitive__desc>`(
	            cpu_engine, att_src_f32_md, att_wei_f32_md, att_dst_f32_md);
	    auto matmul_f32_prim = :ref:`matmul <doxid-structdnnl_1_1matmul>`(matmul_f32_pd);
	    auto src_f32_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_f32_pd.src_desc(), cpu_engine,
	            dec_src_layer_memory.:ref:`get_data_handle <doxid-structdnnl_1_1memory_1a24aaca8359e9de0f517c7d3c699a2209>`());
	    auto wei_f32_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(matmul_f32_pd.weights_desc(), cpu_engine,
	            user_weights_attention_src_layer.data());
	    auto dst_f32_mem = :ref:`memory <doxid-structdnnl_1_1memory>`(
	            matmul_f32_pd.dst_desc(), cpu_engine, weighted_src_layer.data());
	    ...
	    auto :ref:`execute <doxid-namespacednnl_1_1graph_1_1ocl__interop_1a8b1d57febf09dc0621d7aa2a8dc13035>` = [&]() {
	        ...
	        for (dim_t i = 0; i < tgt_seq_length_max; i++) {
	            ...
	            src_f32_mem.:ref:`set_data_handle <doxid-structdnnl_1_1memory_1a34d1c7dbe9c6302b197f22c300e67aed>`(src_att_layer_handle);
	
	            //[att ctx]
	            compute_attention(src_att_iter_handle, src_seq_length_max, batch,
	                    feature_size,
	                    (float *)enc_bidir_dst_layer_memory.get_data_handle(),
	                    weighted_annotations.data(), src_f32_mem, wei_f32_mem,
	                    dst_f32_mem, matmul_f32_prim, src_gemv_mem, wei_gemv_mem,
