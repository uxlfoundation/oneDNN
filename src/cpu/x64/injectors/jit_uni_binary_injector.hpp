...
struct rhs_arg_static_params_t {
    rhs_arg_static_params_t(dim_t rhs_dt_helper_vmm_idx,
    ...
    mutable dim_t rhs_dt_helper_vmm_idx;
...
public:
     ...
     */
    void compute_vector_range(dim_t start_idx, dim_t end_idx, dim_t rhs_arg_idx,
     ...
     */
    void compute_vector(dim_t idx, dim_t rhs_arg_idx,
            const dnnl_post_ops::entry_t &post_op,
            const rhs_arg_dynamic_params_t &rhs_arg_params) const;
...
private:
     ...
     * ptr to it.
     */
    Xbyak::Address prepare_rhs_arg_addr(dim_t vmm_idx, dim_t rhs_arg_idx,
            const dnnl_post_ops::entry_t &post_op,
