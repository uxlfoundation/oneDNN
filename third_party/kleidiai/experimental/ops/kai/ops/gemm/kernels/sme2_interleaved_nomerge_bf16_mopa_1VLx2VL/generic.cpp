...
void sme2_interleaved_nomerge_bf16_mopa_1VLx2VL(const bfloat16 *const A, const bfloat16 *const B, bfloat16 *const C, int ldc, const int M, const int N, const int K, const bfloat16 *const bias, const Activation act, bool accumulate, bfloat16 *const accumulator_buffer)
{
  ...
  __asm__ __volatile__(
      ...
      ".inst 0xa040a618  // ld1h { z24.h-z27.h }, pn9.b/Z, [x16]\n"
      ".inst 0xa041a61c  // ld1h { z28.h-z31.h }, pn9.b/Z, [x16, #0x4, MUL VL]\n"
      "addvl x16, x16, #8\n"
      ".inst 0xc0440700  // mova za0h.h[x12, 0:3], { z24.h-z27.h }\n"
      ...
      "cbz x21, 6f\n"
      "mov x20, #0x3f80\n"
      ".inst 0xa10b22b4  // ld1h { z20.h, z28.h }, p8/Z, [x21, x11, LSL #1]\n"
      "dup z1.h, w20\n"
      ".inst 0x81b40028  // bfmopa za0.h, p0/M, p0/M, z1.h, z20.h\n"
      ".inst 0x81bc0029  // bfmopa za1.h, p0/M, p0/M, z1.h, z28.h\n"
      ...
      "ble 8f\n"
      "7:"  // K loop
      ".inst 0x81a30288  // bfmopa za0.h, p0/M, p0/M, z20.h, z3.h\n"
      "subs x21, x21, #0x1\n"
      ".inst 0x81a70289  // bfmopa za1.h, p0/M, p0/M, z20.h, z7.h\n"
      ".inst 0x81ab02a8  // bfmopa za0.h, p0/M, p0/M, z21.h, z11.h\n"
      ".inst 0x81af02a9  // bfmopa za1.h, p0/M, p0/M, z21.h, z15.h\n"
      ".inst 0xa140a763  // ld1h { z3.h, z7.h, z11.h, z15.h }, pn9.b/Z, [x27]\n"
      ".inst 0x81a102c8  // bfmopa za0.h, p0/M, p0/M, z22.h, z1.h\n"
      ".inst 0x81a502c9  // bfmopa za1.h, p0/M, p0/M, z22.h, z5.h\n"
      ".inst 0x81a902e8  // bfmopa za0.h, p0/M, p0/M, z23.h, z9.h\n"
      ".inst 0x81ad02e9  // bfmopa za1.h, p0/M, p0/M, z23.h, z13.h\n"
      ".inst 0xa040a754  // ld1h { z20.h-z23.h }, pn9.b/Z, [x26]\n"
      "addvl x26, x26, #4\n"
      ".inst 0xa141a761  // ld1h { z1.h, z5.h, z9.h, z13.h }, pn9.b/Z, [x27, #0x4, MUL VL]\n"
      "addvl x27, x27, #8\n"
      ...
      "addvl x27, x27, #2\n"
      ".inst 0x81a70208  // bfmopa za0.h, p0/M, p0/M, z16.h, z7.h\n"
      ".inst 0x81af0209  // bfmopa za1.h, p0/M, p0/M, z16.h, z15.h\n"
      "bgt 10b\n"
      "11:"  // K oddments: End
      "tbz x17, #1, 15f\n"
      "tbz x17, #0, 13f\n"
      ...
      ".inst 0xc134cab8  // bfclamp { z24.h-z27.h }, z21.h, z20.h\n"
      "add x12, x12, #0x4\n"
      "cmp x12, x21, LSL #2\n"
      ".inst 0xa1602330  // st1h { z16.h, z24.h }, p8, [x25]\n"
      "add x25, x25, x23\n"
      ...
      ".inst 0xc046044c  // mova { z12.h-z15.h }, za1h.h[x12, 0:3]\n"
      "subs x20, x20, #0x1\n"
      ".inst 0xc134caa4  // bfclamp { z4.h-z7.h }, z21.h, z20.h\n"
      ".inst 0xc134caac  // bfclamp { z12.h-z15.h }, z21.h, z20.h\n"
      ".inst 0xa1602324  // st1h { z4.h, z12.h }, p8, [x25]\n"
      "add x25, x25, x23\n"
      "beq 22f\n"
      "subs x20, x20, #0x1\n"
