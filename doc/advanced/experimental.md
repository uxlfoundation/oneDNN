...
[Microkernel APIs section](@ref dev_guide_ukernel_basic_concepts).
...
[Grouped Memory Format section](@ref dev_guide_grouped_mem) and
[MatMul Grouped GEMM section](@ref dev_guide_matmul_grouped_gemm).
