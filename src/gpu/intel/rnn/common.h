...
off_t off_ws_grid_offset(
        int n_layer, int n_dir, int n_iter, int batch, int dhc,
...
off_t off_scratch_diff_states(int n_layer, int n_dir, int n_states,
        int n_iter,
