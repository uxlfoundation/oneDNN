...
#ifndef CPU_PPC64_PPC64_UNI_REORDER_HPP
#define CPU_PPC64_PPC64_UNI_REORDER_HPP
...
struct ppc64_uni_reorder_t : public primitive_t {
    using primitive_t::primitive_t;
    struct pd_t : public cpu_reorder_pd_t {
        using cpu_reorder_pd_t::cpu_reorder_pd_t;

        DECLARE_COMMON_PD_T("ppc64::uni_reorder", ppc64_uni_reorder_t);
...
/*
struct ppc64_blk_reorder_t : public primitive_t {
    using primitive_t::primitive_t;
    struct pd_t : public cpu_reorder_pd_t {
        using cpu_reorder_pd_t::cpu_reorder_pd_t;
