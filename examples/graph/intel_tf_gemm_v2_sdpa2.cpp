...
int main() {
    ...
    std::vector<int64_t> dot1_in2_shape {8, 256, 2};
    std::vector<int64_t> dot1_out_shape {8, 31, 2};
    ...
    std::vector<int64_t> reshape1_out_shape {1, 8, 31, 1, 2};
    logical_tensor lt_reshape1_out {lt_id++, logical_tensor::data_type::f32,
            reshape1_out_shape, logical_tensor::layout_type::strided};
    ...
    reshape_1_op.add_input(lt_mul2_out);
    ...
    add_op.add_inputs({lt_reshape1_out, lt_add_in2});
    add_op.add_output(lt_add_out);

    std::vector<int64_t> tr1_out_shape {1, 8, 2, 1, 31};
    ...
    transpose_1_op.add_input(lt_add_out);
    ...
    logical_tensor lt_softmax_out {lt_id++, logical_tensor::data_type::f32,
            logical_tensor::layout_type::strided};
    softmax_op.add_input(lt_tr1_out);
    ...
    transpose_2_op.add_output(lt_tr2_out);

    std::vector<int64_t> reshape2_out_shape {8, 31, 2};
    ...
    std::vector<int64_t> dot2_in1_shape {8, 256, 31};
    std::vector<int64_t> dot2_out_shape {8, 256, 2};
    ...
    compiled_partition cp = partitions[0].compile(
            {lt_dot1_in1, lt_dot1_in2, lt_mul1_in2, lt_mul2_in2, lt_add_in2,
                    lt_dot2_in1},
            {lt_dot2_out}, eng);
    ...
    cp.execute(strm,
            {ts_dot1_in1, ts_dot1_in2, ts_mul1_in2, ts_mul2_in2, ts_add_in2,
                    ts_dot2_in1},
            {ts_dot2_out});
