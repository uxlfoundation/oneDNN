...
.. index:: pair: example; matmul_with_weight_only_quantization.cpp
.. _doxid-matmul_with_weight_only_quantization_8cpp-example:

matmul_with_weight_only_quantization.cpp
========================================

Annotated version: :ref:`MatMul Tutorial: Weight-only Quantization <doxid-matmul_with_weight_only_quantization_cpp>`
...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	:ref:`matmul::primitive_desc <doxid-structdnnl_1_1matmul_1_1primitive__desc>` matmul_pd_create(
	    ...
	    attr.set_zero_points(:ref:`DNNL_ARG_WEIGHTS <doxid-group__dnnl__api__primitives__common_1gaf279f28c59a807e71a70c719db56c5b3>`, /* mask */ (1 << 0) + (1 << 1),
	            {G, 1}, :ref:`memory::data_type::s8 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea3e8d88fdd85d7153525e0647cdd97686>`);
	    // Set fpmath mode with `apply_to_int=true` to apply fpmath mode behavior to
	    // integral primitives (in this example, matmul).
	    attr.set_fpmath_mode(:ref:`fpmath_mode::strict <doxid-group__dnnl__api__cpp__fpmath__mode_1gga0ad94cbef13dce222933422bfdcfa725a2133fd717402a7966ee88d06f9e0b792>`, true);
	...
	void infer(const :ref:`matmul <doxid-structdnnl_1_1matmul>` &matmul_p, int64_t M, int64_t N, int64_t K, int64_t G,
	    ...
	    :ref:`memory <doxid-structdnnl_1_1memory>` zp_B_mem({{N, n_groups}, :ref:`memory::data_type::s8 <doxid-structdnnl_1_1memory_1a8e83474ec3a50e08e37af76c8c075dcea3e8d88fdd85d7153525e0647cdd97686>`, {1, N}}, eng);
	...
	void matmul_with_weight_only_quantization(:ref:`engine::kind <doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind) {
