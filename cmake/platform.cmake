...
if (DNNL_TARGET_ARCH STREQUAL "RV64")
    ...
    set(DNNL_RISCV_USE_RVV_INTRINSICS ${CAN_COMPILE_RVV_INTRINSICS} CACHE BOOLEAN "Enable RISC-V RVV")
    if (${DNNL_RISCV_USE_RVV_INTRINSICS})
        add_definitions(-DDNNL_RISCV_USE_RVV_INTRINSICS)
    endif()

    set(DNNL_RISCV_USE_ZVFH_INTRINSICS ${CAN_COMPILE_ZVFH_INTRINSICS} CACHE BOOLEAN "Enable RISC-V Zvfh")
