...
struct EmulationImplementation {
    ...
    static void emov(Generator &g, const InstructionModifier &mod, RegData dst, RegData src0, const EmulationStrategy &strategy)
    {
    ...
    template <typename DT = void, typename Generator>
    static void emov(Generator &g, const InstructionModifier &mod, RegData dst, Immediate src0, const EmulationStrategy &strategy)
    {
        applyDefaultType<DT>(dst);
        applyDefaultType<DT>(src0);
    ...
    static void eaddSignExtend1(Generator &g, const InstructionModifier &mod, bool &doSub, const Immediate &src1, Immediate &s1LoPos, const Immediate &s1Lo, const Immediate &s1Hi, bool &s1Q, const GRF (&temp)[2])
    {
    ...
    template <typename Generator>
    static void eaddSignExtend1(Generator &g, const InstructionModifier &mod, bool &doSub, const RegData &src1, RegData &s1LoPos, RegData &s1Lo, RegData &s1Hi, bool &s1Q, const GRF (&temp)[2])
    {
        s1Q = true;
        s1Hi = temp[0].d();
        if (s1Lo.getNeg()) {
    ...
    template <typename Generator>
    static void eaddFixupQD(Generator &g, const InstructionModifier &mod, const FlagRegister &flag, const RegData &dstHi, const RegData &src1)
    {
    ...
    template <typename Generator>
    static void eaddFixupQD(Generator &g, const InstructionModifier &mod, const FlagRegister &flag, const RegData &dstHi, const Immediate &src1)
    {
        /* no-op */
    }
    ...
    static void eaddInternal(Generator &g, const InstructionModifier &mod, RegData dst, RegData src0, S1 src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
            ...
            if (!dstQ) {
                ...
                if (flag.isValid() && !eaddIsNegative(s0Lo)) {
                    ...
                    if (s0Q && s1Q)
                        ...
                        g.mov(mod, dstHi, 0);
                    g.add(mod | Mx | (revFlag ? ~flag : flag), dstHi, dstHi, neg ? -1 : +1);
                    ...
                    if (s0Signed != s1Signed) {
                        if (s0Signed) {
                            ...
                            eaddSignExtend1(g, mod, doSub, src1, s1LoPos, s1Lo, s1Hi, s1Q, temp);
                        carry = temp[1].ud();
                        lateCarry = true;
                    }
                    ...
                    if (dstLo.getOffset() != 0) {
                        doSub ? g.subb(mod, g.null.retype(s0Lo.getType()), s0Lo, s1LoPos)
                              : g.addc(mod, g.null.retype(s0Lo.getType()), s0Lo, s1Lo);
                        g.add(mod, dstLo, s0Lo, s1Lo);
    ...
    template <typename DT = void, typename Generator>
    static void eadd(Generator &g, const InstructionModifier &mod, const RegData &dst, const RegData &src0, const RegData &src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
    ...
    template <typename DT = void, typename Generator>
    static void eadd(Generator &g, const InstructionModifier &mod, const RegData &dst, const RegData &src0, Immediate src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        eaddInternal<DT>(g, mod, dst, src0, src1, strategy, state);
    }
    ...
    template <typename DT = void, typename S1, typename Generator>
    static void emulInternal(Generator &g, const InstructionModifier &mod, RegData dst, RegData src0, S1 src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        applyDefaultType<DT>(dst);
        applyDefaultType<DT>(src0);
        applyDefaultType<DT>(src1);
    ...
    template <typename DT = void, typename Generator>
    static void emul(Generator &g, const InstructionModifier &mod, const RegData &dst, const RegData &src0, const RegData &src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        emulInternal<DT>(g, mod, dst, src0, src1, strategy, state);
    }

    template <typename DT = void, typename Generator>
    static void emul(Generator &g, const InstructionModifier &mod, const RegData &dst, const RegData &src0, Immediate src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        emulInternal<DT>(g, mod, dst, src0, src1, strategy, state);
    }

    template <typename S1, typename Generator>
    static void emul32High(Generator &g, const InstructionModifier &mod, const RegData &dstHi, const RegData &src0, const S1 &src1)
    {
    ...
    template <typename DT = void, typename Generator>
    static void eshl(Generator &g, const InstructionModifier &mod, RegData dst, RegData src0, uint16_t src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        const auto &temp = state.temp;
    ...
    template <typename DT = void, typename Generator>
    static void eshr(Generator &g, const InstructionModifier &mod, RegData dst, RegData src0, uint16_t src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        const auto &temp = state.temp;
    ...
    template <typename DT = void, typename Generator>
    static void emulConstant(Generator &g, const InstructionModifier &mod, const RegData &dst, const RegData &src0, int32_t src1, const EmulationStrategy &strategy, const EmulationState &state)
    {
        if (src1 == 0)
            ...
            eshl<DT>(g, mod, dst, src0, uint16_t(utils::log2(src1)), strategy, state);
        else if (src1 > 0)
