...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Shuffle examples are listed in the :ref:`Tensor Operations <doxid-dev_guide_examples_1examples_tensor_operations>` section.
