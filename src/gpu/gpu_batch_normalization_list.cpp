...
#include "gpu/intel/bnorm/gen9_batch_normalization.hpp"
...
const std::map<pk_impl_key_t, std::vector<impl_list_item_t>>
    ...
    {{forward}, {
        ...
        GPU_INSTANCE_INTEL(intel::gen9_batch_normalization_fwd_t)
    ...
    {{backward}, REG_BWD_PK({
        ...
        GPU_INSTANCE_INTEL(intel::gen9_batch_normalization_bwd_t)
