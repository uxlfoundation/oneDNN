...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Softmax examples are listed in the :ref:`Activation Functions <doxid-dev_guide_examples_1examples_activation>` section.
