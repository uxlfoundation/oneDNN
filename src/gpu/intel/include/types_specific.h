...
#define DST_SCALE_OFF(x0, x1, d, h, x2, g0, g1) \
    (((x0) % DST_B0) *(DST_SB0 / (g0 * g1)) + ((x0) / DST_B0) * (DST_S0 / (g0)) \
            + ((x1) % DST_B1) * (DST_SB1 / (g0 * g1)) + ((x1) / DST_B1) * (DST_S1 / (g0 * g1)) \
            + ((x2) % DST_B2) * (DST_SB2 / (g0 * g1)) + ((x2) / DST_B2) * (DST_S2 / (g0 * g1)))
#elif NDIMS == 4
...
#define DST_SCALE_OFF(x0, x1, d, x2, x3, g0, g1) \
    (((x0) % DST_B0) * (DST_SB0 / (g0 * g1)) + ((x0) / DST_B0) * (DST_S0 / (g0)) \
            + ((x1) % DST_B1) * (DST_SB1 / (g0 * g1)) + ((x1) / DST_B1) * (DST_S1 / (g0 * g1)) \
            + ((x2) % DST_B2) * (DST_SB2 / (g0 * g1)) + ((x2) / DST_B2) * (DST_S2 / (g0 * g1)) \
            + ((x3) % DST_B3) * (DST_SB3 / (g0 * g1)) + ((x3) / DST_B3) * (DST_S3 / (g0 * g1)))
#elif NDIMS == 5
