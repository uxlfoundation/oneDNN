...
extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::XeLP>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::XeLP> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);

extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::XeHP>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::XeHP> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);

extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::XeHPG>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::XeHPG> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);

extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::XeHPC>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::XeHPC> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);

extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::Xe2>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::Xe2> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);

extern template void convert_ir_to_ngen<ngen_code_generator_t<ngen::HW::Xe3>>(
        const stmt_t &body, ngen_code_generator_t<ngen::HW::Xe3> &host,
        const walk_order_t *kernel_grid_walk_order = nullptr);
...
#define GPU_HW_CASE(hw) \
    using gen_type = ir_to_ngen_generator_t<ngen_code_generator_t<(hw)>>; \
    auto gen = gen_type(kernel_iface_, options_, debug_config_); \
    gen.setInterface( \
    ...
    generator_.reset(new generator_t<(hw)>( \
            static_cast<ngen_code_generator_t<(hw)> &&>(gen)));
